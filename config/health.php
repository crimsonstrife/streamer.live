...
return [
    ...
    'notifications' => [
         ...
         * Defaults to false so local/dev environments don't attempt SMTP on every check run.
         * Set HEALTH_NOTIFICATIONS_ENABLED=true in production .env to enable.
         */
        ...
        /*
         * Only send notifications when at least one check has a hard 'failed' status.
         * Warnings (e.g. disk space above 70%) will not trigger an alert.
         */
