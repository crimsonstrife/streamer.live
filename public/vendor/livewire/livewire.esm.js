  ...
  '../alpine/packages/alpinejs/dist/module.cjs.js' (exports, module) {
    ...
    const require_reactivity_cjs = __commonJS2({
      'node_modules/@vue/reactivity/dist/reactivity.cjs.js' (exports2) {
        ...
        const isNonTrackableKeys = /* @__PURE__ */ shared.makeMap(
        ...
        const shallowReadonlyGet = /* @__PURE__ */ createGetter(
          true,
          true
        )
    ...
    directive2(
      ...
      skipDuringClone(
        (el, { value, modifiers, expression }, { cleanup }) => {
          ...
          const removeListener = on3(el, value, modifiers, (e) => {
            evaluate2(() => {}, {
              scope: { $event: e },
              params: [e]
            })
  ...
  '../alpine/packages/collapse/dist/module.cjs.js' (exports, module) {
    ...
    function src_default (Alpine20) {
      ...
      function collapse3 (el, { modifiers }) {
        const duration =
                    modifierValue(modifiers, 'duration', 250) / 1e3
        ...
        const setFunction = (el2, styles) => {
          const revertFunction = Alpine20.setStyles(el2, styles)
  ...
  '../alpine/packages/focus/dist/module.cjs.js' (exports, module) {
    ...
    const require_dist = __commonJS2({
      'node_modules/tabbable/dist/index.js' (exports2) {
        ...
        const getCandidatesIteratively =
                    function getCandidatesIteratively2 (
                      ...
                      while (elementsToCheck.length) {
                        ...
                        if (element.tagName === 'SLOT') {
                          ...
                          const validCandidate = matches.call(
                            element,
                            candidateSelector
                          )
                          if (
        ...
        const sortOrderedTabbables = function sortOrderedTabbables2 (
          a,
          b
        ) {
        ...
        const isDetailsWithSummary = function isDetailsWithSummary2 (
          node
        ) {
          const r =
        ...
        const isDisabledFromFieldset = function isDisabledFromFieldset2 (
          node
        ) {
        ...
        const isValidShadowRootTabbable =
        ...
        const focusable2 = function focusable3 (el, options) {
          options = options || {}
          let candidates
          if (options.getShadowRoot) {
            candidates = getCandidatesIteratively(
    ...
    const require_focus_trap = __commonJS2({
      'node_modules/focus-trap/dist/focus-trap.js' (exports2) {
        ...
        const createFocusTrap2 = function createFocusTrap3 (
          elements,
          userOptions
        ) {
          const doc =
          ...
          const findContainerIndex = function findContainerIndex2 (
            element
          ) {
          ...
          const getNodeForOption = function getNodeForOption2 (
            optionName
          ) {
          ...
          const getInitialFocusNode =
                        function getInitialFocusNode2 () {
                          ...
                          if (node === void 0) {
                            if (
                              findContainerIndex(doc.activeElement) >= 0
                            ) {
                              node = doc.activeElement
                            } else {
                              const firstTabbableGroup =
          ...
          const updateTabbableNodes =
                        function updateTabbableNodes2 () {
                          state.containerGroups = state.containers.map(
                            function (container) {
                              const tabbableNodes = tabbable.tabbable(
                                container,
                                config.tabbableOptions
                              )
                              const focusableNodes = tabbable.focusable(
                                container,
                                config.tabbableOptions
                              )
                              return {
          ...
          const getReturnFocusNode = function getReturnFocusNode2 (
            ...
            return (
              node ||
                            (node === false ? false : previousActiveElement)
            )
          }
          ...
          trap = {
            ...
            deactivate: function deactivate (deactivateOptions) {
              ...
              const onDeactivate = getOption(
                options,
                'onDeactivate'
              )
              const onPostDeactivate = getOption(
                options,
                'onPostDeactivate'
              )
      ...
      Alpine20.directive(
        ...
        Alpine20.skipDuringClone(
          (
            ...
            const trap = (0, import_focus_trap.createFocusTrap)(
              el,
              options
            )
            let undoInert = () => {}
  ...
  'node_modules/nprogress/nprogress.js' (exports, module) {
    (function (root, factory) {
      ...
      NProgress2.set = function (n) {
        ...
        const progress = NProgress2.render(!started)
...
function generateEntangleFunction (component, cleanup) {
  ...
  return (name, live = false) => {
    ...
    const interceptor = import_alpinejs.default.interceptor(
      (initialValue, getter, setter, path, key) => {
...
wireProperty('$hook', (component) => (name, callback) => {
  const unhook = on(name, ({ component: hookComponent, ...params }) => {
...
function initComponent (el) {
  ...
  const cleanup = (i) => component.addCleanup(i)
...
function closestComponent (el, strict = true) {
  const closestRoot = Alpine.findClosest(el, (i) => i.__livewire)
  if (!closestRoot) {
...
function start () {
  ...
  import_alpinejs5.default.onAttributesAdded((el, attributes) => {
    ...
    attributes.forEach((attribute) => {
      ...
      const directive2 = extractDirective(el, attribute.name)
  ...
  import_alpinejs5.default.interceptInit(
    import_alpinejs5.default.skipDuringClone((el) => {
      ...
      const directives = Array.from(el.getAttributeNames())
        .filter((name) => matchesForLivewireDirective(name))
...
// js/index.js
const import_alpinejs18 = __toESM(require_module_cjs())
...
on('directive.init', ({ el, directive: directive2, cleanup, component }) =>
  setTimeout(() => {
    ...
    el.addEventListener('submit', () => {
      const componentId = directive2.expression.startsWith('$parent')
        ? component.parent.id
        : component.id
...
on('effect', ({ component, effects }) => {
  ...
  listeners2.forEach((event) => {
    if (event.startsWith('echo')) {
      ...
      const [s1, signature, channel_type, s2, channel, s3, event_name] =
                event_parts
      if (
...
directive('transition', ({ el, directive: directive2, component, cleanup }) => {
  const visibility = import_alpinejs11.default.reactive({
...
const export_Alpine = import_alpinejs18.default
