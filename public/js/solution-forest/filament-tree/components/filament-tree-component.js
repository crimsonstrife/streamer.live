...
const at = er((Rn, bt) => {
  (function (h, N) {
        ...
        if (!y && (je(c), (c = c || a), f)) {
          if (_ !== 11 && (w = fe.exec(u))) {
            if ((m = w[1])) {
              ...
              if (w[2]) {
                return (
                  s.apply(p, c.getElementsByTagName(u)),
                  p
                )
              }
              if ((m = w[3]) && c.getElementsByClassName) {
                return (
                  s.apply(p, c.getElementsByClassName(m)),
                  p
                )
              }
            }
    ...
    r.event = {
      ...
      dispatch: function (e) {
        ...
        if (
          ...
          return (
            v.postDispatch && v.postDispatch.call(this, f),
            f.result
          )
        }
      },
    ...
    function Ci (e, t, n) {
      ...
      n.queue ||
                ...
                g.always(function () {
                  g.always(function () {
                    (a.unqueued--,
                    r.queue(e, 'fx').length || a.empty.fire())
                  })
                }))
      for (i in t) {
        if (((o = t[i]), bi.test(o))) {
    ...
    (Tn = {
      set: function (e, t, n) {
        return (
          t === !1 ? r.removeAttr(e, n) : e.setAttribute(n, n),
          n
        )
      }
    }),
