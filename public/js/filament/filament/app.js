(() => {
  ...
  const ae = (s) => L(s, '__esModule', { value: !0 })
  const ie = (s, n) => () => (
  ...
  const fe = ie((s, n) => {
    (function (p, d, M) {
      ...
      function v (e) {
        ...
        function z (r, o, l, i) {
          ...
          for (let f = 0; f < o.length; ++f) {
            const _ = f + 1 === o.length
            const A = _ ? m : u(i || I(o[f + 1]).action)
            N(o[f], A, i, r, f)
          }
        }
        ...
        ((t._bindMultiple = function (r, o, l) {
          for (let i = 0; i < r.length; ++i) N(r[i], o, l)
        }),
        C(e, 'keypress', G),
        C(e, 'keydown', G),
        C(e, 'keyup', G))
      ...
      (v.addKeycodes = function (e) {
        for (const t in e) e.hasOwnProperty(t) && (h[t] = e[t])
        S = null
      }),
      (v.init = function () {
        const e = v(d)
  ...
  (function (s) {
    if (s) {
      const n = {}
      const p = s.prototype.stopCallback;
      ...
      (s.prototype.bindGlobal = function (d, M, h) {
        ...
        if ((g.bind(d, M, h), d instanceof Array)) {
          for (let y = 0; y < d.length; y++) n[d[y]] = !0
          return
        }
        n[d] = !0
      }),
