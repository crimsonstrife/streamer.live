...
const W = (i) => (typeof i === 'number' || i instanceof Number) && isFinite(+i)
function Q (i, t) {
  return W(i) ? i : t
}
function C (i, t) {
...
const J = (i) => typeof i < 'u'
const ft = (i) => typeof i === 'function'
const Oi = (i, t) => {
...
const at = (i, t, e, s) =>
  qe(i, e, s ? (n) => i[n][t] <= e : (n) => i[n][t] < e)
const qs = (i, t, e) => qe(i, e, (s) => i[s][t] >= e)
function Gs (i, t, e) {
  let s = 0
  let n = i.length
  for (; s < n && i[s] < t;) s++
...
const Ge = (i) => (i === 'start' ? 'left' : i === 'end' ? 'right' : 'center')
const X = (i, t, e) => (i === 'start' ? t : i === 'end' ? e : (t + e) / 2)
const tn = (i, t, e, s) =>
...
const Ts = (i, t, e) => Math.pow(2, -10 * i) * Math.sin(((i - t) * F) / e) + 1
var Ht = {
  linear: (i) => i,
  easeInQuad: (i) => i * i,
  easeOutQuad: (i) => -i * (i - 2),
...
const No = (i) => Pi[i & 15]
const Ho = (i) => Pi[(i & 240) >> 4] + Pi[i & 15]
const Ve = (i) => (i & 240) >> 4 === (i & 15)
const jo = (i) => Ve(i.r) && Ve(i.g) && Ve(i.b) && Ve(i.a)
function $o (i) {
  const t = i.length
  let e
  return (
...
function ia () {
  const i = {}
  const t = Object.keys(Es)
  const e = Object.keys(Rs)
  let s
  let n
  let o
  let a
...
var $t = class {
  ...
  greyscale () {
    const t = this._rgb
    const e = _e(t.r * 0.3 + t.g * 0.59 + t.b * 0.11)
...
const ua = new RegExp(/^(normal|(\d+(?:\.\d+)?)(px|em|%)?)$/)
const fa = new RegExp(
...
function Qe (i, t) {
  ...
  const o = D(i) ? (s ? (a) => C(i[a], i[t[a]]) : (a) => i[a]) : () => i
  for (const a of n) e[a] = pa(o(a))
  return e
}
function Xi (i) {
...
const ya = (i, t) => (i === !0 ? t : typeof i === 'string' ? gt(t, i) : void 0)
function va (i, t, e, s, n) {
  for (const o of t) {
    const a = ya(e, o)
    if (a) {
      i.add(a)
      const r = un(a._fallback, e, n)
...
const Sa = Number.EPSILON || 1e-14
const Xt = (i, t) => t < i.length && !i[t].skip && i[t]
const gn = (i) => (i === 'x' ? 'y' : 'x')
function Pa (i, t, e, s) {
  const n = i.skip ? t : i
  const o = t
...
const ii = (i) => window.getComputedStyle(i, null)
function Ta (i, t) {
...
function Pt (i, t) {
  ...
  const a = Tt(n, 'padding')
  const r = Tt(n, 'border', 'width')
  const { x: l, y: c, box: h } = Ea(i, e)
...
function Fa (i, t, e) {
  ...
  if (t === void 0 || e === void 0) {
    ...
    if (!o) (t = i.clientWidth), (e = i.clientHeight)
      ...
      const r = ii(o)
      const l = Tt(r, 'border', 'width')
      const c = Tt(r, 'padding');
...
function mn (i, t, e, s) {
  const n = ii(i)
  const o = Tt(n, 'margin')
  const a = Xe(n.maxWidth, i, 'clientWidth') || $e
  const r = Xe(n.maxHeight, i, 'clientHeight') || $e
  const l = Fa(i, t, e)
  let { width: c, height: h } = l
  if (n.boxSizing === 'content-box') {
    const d = Tt(n, 'border', 'width')
    const u = Tt(n, 'padding');
...
function Va (i, t, e) {
  ...
  const { between: a, normalize: r } = yn(s)
  const l = t.length
...
function is (i, t, e) {
  ...
  const { property: s, start: n, end: o } = e
  const a = t.length
  const { compare: r, between: l, normalize: c } = yn(s)
  const { start: h, end: d, loop: u, style: f } = Va(i, t, e)
  const g = []
  let p = !1
  let m = null
  let b
...
function vn (i, t) {
  ...
  if (!n) return []
  const o = !!i._loop
  const { start: a, end: r } = Wa(e, n, o, s)
...
const Ya = ['x', 'y', 'borderWidth', 'radius', 'tension']
const Xa = ['color', 'borderColor', 'backgroundColor']
O.set('animation', {
  delay: void 0,
  duration: 1e3,
  easing: 'easeOutQuart',
...
const Ua = Object.keys(O.animation)
...
const os = (i) => i === 'reset' || i === 'none'
const Dn = (i, t) => (t ? i : Object.assign({}, i))
const nr = (i, t, e) =>
...
const et = class {
  ...
  linkScales () {
    ...
    const o = (e.xAxisID = C(s.xAxisID, ns(t, 'x')))
    const a = (e.yAxisID = C(s.yAxisID, ns(t, 'y')))
    const r = (e.rAxisID = C(s.rAxisID, ns(t, 'r')))
    const l = e.indexAxis
  ...
  applyStack (t, e, s) {
    ...
    const a = e[t.axis]
    const r = { keys: go(n, !0), values: e._stacks[t.axis] }
  ...
  getMinMax (t, e) {
    ...
    const l = nr(e, s, this.chart)
    const c = {
      min: Number.POSITIVE_INFINITY,
      max: Number.NEGATIVE_INFINITY
    }
    const { min: h, max: d } = tr(r)
    let u
    let f
    function g () {
      f = n[u]
  ...
  _resolveElementOptions (t, e = 'default', s) {
    ...
    const a = t + '-' + e
    const r = o[a]
    const l = this.enableOptionSharing && J(s)
    if (r) return Dn(r, l)
    ...
    const f = Object.keys(O.elements[t])
  ...
  _resolveAnimations (t, e, s) {
    ...
    const c = new hi(n, l && l.animations)
...
const ee = class extends et {
  ...
  _calculateBarValuePixels (t) {
    ...
    let h = r[e.axis]
    let d = 0
    let u = s ? this.applyStack(e, r, s) : h
    let f
    let g
    u !== h && ((d = u - h), (u = h)),
    c &&
    ...
    if (
      ...
      const v = Math.min(b, _)
      const y = Math.max(b, _);
  ...
  _calculateBarIndexPixels (t, e) {
    ...
    const o = n.skipNull
    const a = C(n.maxBarThickness, 1 / 0)
    let r
    let l
    if (e.grouped) {
      const c = o ? this._getStackCount(t) : e.stackCount
      const h =
                n.barThickness === 'flex' ? lr(t, e, n, c) : rr(t, e, n, c)
      const d = this._getStackIndex(
        this.index,
...
const Ot = class extends et {
  ...
  update (t) {
    ...
    const l = Math.min(js(this.options.cutout, r), 1)
    const c = this._getRingWeight(this.index)
    const { circumference: h, rotation: d } = this._getRotationExtents()
    const { ratioX: u, ratioY: f, offsetX: g, offsetY: p } = pr(d, h, l)
    const m = (s.width - a) / u
    const b = (s.height - a) / f
    const _ = Math.max(Math.min(m, b) / 2, 0)
    const v = Di(this.options.radius, _)
    const y = Math.max(v * l, 0)
    const x = (v - y) / this._getVisibleDatasetWeightTotal();
    (this.offsetX = g * v),
    (this.offsetY = p * v),
  ...
  getLabelAndValue (t) {
    ...
    const o = Jt(e._parsed[t], s.options.locale)
...
const se = class extends et {
  ...
  updateElements (t, e, s, n) {
    ...
    const m = Rt(g) ? g : Number.POSITIVE_INFINITY
    ...
    for (let v = e; v < e + s; ++v) {
      ...
      const M = b ? y : {}
      const w = T(x[f])
      const S = (M[u] = a.getPixelForValue(x[u], v))
      const k = (M[f] =
                o || w
                  ? r.getBasePixel()
                  : r.getPixelForValue(
...
const ne = class extends et {
  ...
  getLabelAndValue (t) {
    ...
    const s = this.chart
    const n = s.data.labels || []
    const o = Jt(e._parsed[t].r, s.options.locale)
    return { label: n[t] || '', value: o }
  }
  ...
  updateElements (t, e, s, n) {
    ...
    const h = c.xCenter
    const d = c.yCenter
    const u = c.getIndexAngle(0) - 0.5 * B
    let f = u
    let g
    ...
    for (g = e; g < e + s; g++) {
      const m = t[g]
      let b = f
      let _ = f + this._computeAngle(g, n, p)
...
var mo = {
  ...
  numeric (i, t, e) {
    ...
    const a = tt(Math.abs(o))
    const r = Math.max(Math.min(-1 * Math.floor(a), 20), 0)
    const l = {
      notation: n,
...
function br (i, t) {
  ...
  const s = e.maxTicksLimit || _r(i)
  const n = e.major.enabled ? yr(t) : []
  const o = n.length
  const a = n[0]
  const r = n[o - 1]
  const l = []
...
function si (i, t, e, s, n) {
  const o = C(s, 0)
  const a = Math.min(C(n, i.length), i.length)
  let r = 0
  let l
  let c
  let h
...
const wr = (i) => (i === 'left' ? 'right' : i === 'right' ? 'left' : i)
const Ln = (i, t, e) => (t === 'top' || t === 'left' ? i[t] + e : i[t] - e)
function Rn (i, t) {
  const e = []
  const s = i.length / t
  const n = i.length
...
var _t = class extends it {
  ...
  _computeLabelSizes (t, e) {
    ...
    const y = o.indexOf(r)
    const x = a.indexOf(l)
    const M = (w) => ({ width: o[w] || 0, height: a[w] || 0 })
    return {
      first: M(0),
      last: M(e - 1),
      widest: M(y),
  ...
  _computeGridLineItems (t) {
    ...
    const h = this.ticks.length + (r ? 1 : 0)
    const d = Me(o)
    const u = []
    const f = o.setContext(this.getContext())
    const g = f.drawBorder ? f.borderWidth : 0
    const p = g / 2
    const m = function (P) {
      return wt(s, P, g)
    }
    ...
    const q = Math.max(1, Math.ceil(h / H))
    for (_ = 0; _ < h; _ += q) {
      const P = o.setContext(this.getContext(_))
      const j = P.lineWidth
      const N = P.color
      const At = P.borderDash || []
      const _i = P.borderDashOffset
      const Vt = P.tickWidth
      const ze = P.tickColor
      const Wt = P.tickBorderDash || []
      const ue = P.tickBorderDashOffset;
      (v = kr(this, _, r)),
      v !== void 0 &&
                    ((y = wt(s, v, j)),
  ...
  _computeLabelItems (t) {
    ...
    for (b = 0, _ = r.length; b < _; ++b) {
      ...
      const j = R / 2
      const N = P.color
      const At = P.textStrokeColor
      const _i = P.textStrokeWidth
      let Vt = w
      a
        ? ((x = S),
          w === 'inner' &&
      ...
      if (P.showLabelBackdrop) {
        const Wt = U(P.backdropPadding)
        const ue = q.heights[b]
        const xi = q.widths[b]
        let yi = M + A - Wt.top
        let vi = x - Wt.left
        switch (H) {
...
const ht = new ps()
const ae = class extends et {
  update (t) {
    const e = this._cachedMeta
    const { data: s = [] } = e
    const n = this.chart._animationsDisabled
    let { start: o, count: a } = Bi(e, s, n)
    if (
      ((this._drawStart = o),
      (this._drawCount = a),
      Vi(e) && ((o = 0), (a = s.length)),
  ...
  updateElements (t, e, s, n) {
    ...
    const b = Rt(p) ? p : Number.POSITIVE_INFINITY
    const _ = this.chart._animationsDisabled || o || n === 'none'
    ...
    for (let y = e; y < e + s; ++y) {
      ...
      const w = _ ? x : {}
      const S = T(M[g])
      const k = (w[f] = a.getPixelForValue(M[f], y))
      const L = (w[g] =
                o || S
                  ? r.getBasePixel()
                  : r.getPixelForValue(
...
function Fr (i, t, e, s) {
  ...
  if (r && t === r.axis && t !== 'r' && a && o.length) {
    const l = r._reversePixels ? qs : at
    if (s) {
      if (n._sharedOptions) {
        const c = o[0]
...
function zr (i, t, e, s) {
  ...
  function o (a, r, l) {
    ...
    const { angle: d } = Ri(a, { x: t.x, y: t.y })
...
const Vr = {
  ...
  modes: {
    index (i, t, e, s) {
      ...
      const r = e.intersect ? rs(i, n, o, s, a) : ls(i, n, o, !1, s, a)
      const l = []
      return r.length
    ...
    dataset (i, t, e, s) {
      ...
      const o = e.axis || 'xy'
      const a = e.includeInvisible || !1
      let r = e.intersect ? rs(i, n, o, s, a) : ls(i, n, o, !1, s, a)
      if (r.length > 0) {
...
const bo = ['left', 'top', 'right', 'bottom']
function we (i, t) {
...
function jr (i) {
  ...
  const s = ke(we(t, 'left'), !0)
  const n = ke(we(t, 'right'))
  const o = ke(we(t, 'top'), !0)
  const a = ke(we(t, 'bottom'))
  const r = In(t, 'x')
  const l = In(t, 'y')
  return {
    fullSize: e,
...
function $r (i, t, e, s) {
  ...
  const r = Math.max(0, t.outerWidth - zn(a, i, 'left', 'right'))
  const l = Math.max(0, t.outerHeight - zn(a, i, 'top', 'bottom'))
  const c = r !== i.w
  const h = l !== i.h
  return (
    (i.w = r),
...
const K = {
  ...
  update (i, t, e, s) {
    if (!i) return
    const n = U(i.options.layout.padding)
...
function Zr (i, t) {
  const e = Ur[i.type] || i.type
  const { x: s, y: n } = Pt(i, t)
  return {
    type: e,
    chart: t,
    native: i,
...
const bs = class extends di {
  ...
  addEventListener (t, e, s) {
    ...
    const a = { attach: Jr, detach: Qr, resize: il }[e] || sl
    n[e] = a(t, e, s)
  }
...
const _s = class {
  ...
  _createDescriptors (t, e) {
    const s = t && t.config
    const n = C(s.options && s.options.plugins, {})
    const o = ol(s)
...
function ol (i) {
  const t = {}
  const e = []
  const s = Object.keys(ht.plugins.items)
...
function ul (i, t) {
  ...
  return (
    ...
    i.data.datasets.forEach((r) => {
      ...
      const c = r.indexAxis || xs(l, t)
      const d = (Mt[l] || {}).scales || {}
      Object.keys(d).forEach((u) => {
        const f = cl(u, c)
        const g = r[f + 'AxisID'] || o[f] || f;
...
const vs = class {
  ...
  resolveNamedOptions (t, e, s, n = ['']) {
    const o = { $shared: !0 }
    const { resolver: a, subPrefixes: r } = Hn(this._resolverCache, t, n)
    let l = a
    if (pl(a, e)) {
  ...
  createResolver (t, e, s = [''], n) {
    const { resolver: o } = Hn(this._resolverCache, t, s)
...
function pl (i, t) {
  const { isScriptable: e, isIndexable: s } = Ui(i)
  for (const n of t) {
    const o = e(n)
    const a = s(n)
    const r = (a || o) && i[n]
...
const ml = '3.9.1'
const bl = ['top', 'bottom', 'left', 'right', 'chartArea']
function jn (i, t) {
...
const It = class {
  ...
  _drawDataset (t) {
    ...
    const a = { meta: t, index: t.index, cancelable: !0 }
...
const Xn = () => E(It.instances, (i) => i._plugins.invalidate())
const Ct = !0
...
function Ml (i, t, e, s) {
  const n = vl(i.options.borderRadius)
  const o = (e - t) / 2
...
function Ms (i, t, e, s, n, o) {
  ...
  if ((i.beginPath(), o)) {
    ...
    i.moveTo(a, r)
    const P = Math.cos(k) * d + a
    const j = Math.sin(k) * d + r
    i.lineTo(P, j)
    const N = Math.cos(L) * d + a
    const At = Math.sin(L) * d + r
    i.lineTo(N, At)
  }
  i.closePath()
}
...
function kl (i, t, e) {
  ...
  const l = Math.max(t.outerRadius - a, 0)
  const c = t.innerRadius + a
  let h
  for (
    e && Po(i, t, o + F),
    i.beginPath(),
...
const re = class extends it {
  ...
  inRange (t, e, s) {
    ...
    const { angle: o, distance: a } = Ri(n, { x: t, y: e })
    const {
      startAngle: r,
      endAngle: l,
      innerRadius: c,
    ...
    const u = this.options.spacing / 2
    const g = C(d, l - r) >= F || qt(o, r, l)
    const p = lt(a, c + u, h + u)
    return g && p
  }
...
function Dl (i, t, e, s) {
  ...
  const { count: a, start: r, loop: l, ilen: c } = Do(n, e, s)
  const h = Cl(o)
...
function Ol (i, t, e, s) {
  const n = t.points
  const { count: o, start: a, ilen: r } = Do(n, e, s)
...
const Rl = typeof Path2D === 'function'
function El (i, t, e, s) {
  Rl && !t.options.segment ? Tl(i, t, e, s) : Ll(i, t, e, s)
}
const dt = class extends it {
  constructor (t) {
    super(),
    (this.animated = !0),
    (this.options = void 0),
  ...
  interpolate (t, e) {
    ...
    const n = t[e]
    const o = this.points
    const a = ss(this, { property: e, start: n, end: n })
    if (!a.length) return
    const r = []
    const l = Al(s)
    let c
...
const le = class extends it {
  ...
  inRange (t, e, s) {
    const n = this.options
    const { x: o, y: a } = this.getProps(['x', 'y'], s)
    return (
...
function zl (i) {
  ...
  const n = Fl(i, e / 2, s / 2)
  const o = Il(i, e / 2, s / 2)
  return {
...
const ce = class extends it {
  ...
  draw (t) {
    ...
    const { inner: o, outer: a } = zl(this)
    const r = Bl(a.radius) ? Gt : Vl
    t.save(),
    (a.w !== o.w || a.h !== o.h) &&
                (t.beginPath(),
                r(t, ds(a, e, o)),
...
function Yl (i, t, e) {
  ...
  for (const r of s) {
    ...
    const d = ss(t, h)
    for (const u of d) {
      const f = ks(e, o[u.start], o[u.end], u.loop)
      const g = is(r, n, f)
      for (const p of g) {
        a.push({
          source: p,
...
function us (i, t, e) {
  const s = sc(t)
  const { line: n, scale: o, axis: a } = t
  const r = n.options
  const l = r.fill
  const c = r.backgroundColor
  const { above: h = c, below: d = c } = l || {}
  s &&
        n.points.length &&
        (xe(i, e),
        lc(i, {
...
function cc (i, t, e) {
  ...
  const { property: o, start: a, end: r } = e || {}
...
const pi = class extends it {
  ...
  fit () {
    ...
    const { boxWidth: r, itemHeight: l } = to(s, o)
    let c
    let h;
    (e.font = n.string),
    this.isHorizontal()
  ...
  adjustHitBoxes () {
    ...
    const a = Et(o, this.left, this.width)
    if (this.isHorizontal()) {
      let r = 0
      let l = X(s, this.left + n, this.right - this.lineWidths[r])
      for (const c of e) {
        r !== c.row &&
                    ((r = c.row),
  ...
  _draw () {
    ...
    const r = O.color
    const l = Et(t.rtl, this.left, this.width)
    const c = $(a.font)
    ...
    (n.lineWidth = 0.5),
    (n.font = c.string)
    const { boxWidth: p, boxHeight: m, itemHeight: b } = to(a, u)
    const _ = function (w, S, k) {
      if (isNaN(p) || p <= 0 || isNaN(m) || m < 0) return
      n.save()
      const L = C(k.lineWidth, 1)
      if (
        ...
        const A = l.xPlus(w, p / 2)
        const H = S + f
        Yi(n, R, A, H, a.pointStyleWidth && p)
      } else {
        const R = S + Math.max((u - m) / 2, 0)
        const A = l.leftForLtr(w, p)
        const H = St(k.borderRadius)
        n.beginPath(),
    ...
    this.legendItems.forEach((w, S) => {
      ...
      const L = l.textAlign(w.textAlign || (w.textAlign = a.textAlign))
      const R = p + f + k
      let A = g.x
      let H = g.y
  ...
  drawTitle () {
    ...
    const n = U(e.padding)
    if (!e.display) return
    const o = Et(t.rtl, this.left, this.width)
    const a = this.ctx
    const r = e.position
    const l = s.size / 2
    const c = n.top + l
...
function gc (i, t) {
  const e = new Te({ ctx: i.ctx, options: t, chart: i })
...
const mc = {
  id: 'subtitle',
  start (i, t, e) {
    const s = new Te({ ctx: i.ctx, options: e, chart: i })
...
function so (i, t, e, s) {
  ...
  const c = n + o
  const { topLeft: h, topRight: d, bottomLeft: u, bottomRight: f } = St(a)
  let g = vc(t, r)
  const p = Mc(t, l, c)
  return (
    l === 'center'
...
const Le = class extends it {
  ...
  getTitle (t, e) {
    ...
    const o = s.title.apply(this, [t])
    const a = s.afterTitle.apply(this, [t])
    let r = []
  ...
  getFooter (t, e) {
    ...
    const o = s.footer.apply(this, [t])
    const a = s.afterFooter.apply(this, [t])
    let r = []
    return (r = ct(r, bt(n))), (r = ct(r, bt(o))), (r = ct(r, bt(a))), r
  }
  ...
  update (t, e) {
    ...
    if (!n.length) this.opacity !== 0 && (o = { opacity: 0 })
      ...
      const r = Ce[s.position].call(this, n, this._eventPosition);
      ...
      const l = (this._size = eo(this, s))
      const c = Object.assign({}, r, l)
      const h = io(this.chart, s, c)
      const d = so(s, c, h, this.chart);
  ...
  _drawColorBox (t, e, s, n, o) {
    ...
    if (o.usePointStyle) {
      ...
      const b = n.leftForLtr(n.xPlus(f, 1), c - h - 2)
      const _ = St(a.borderRadius)
  ...
  drawBody (t, e, s) {
    ...
    let u = d.lineHeight
    let f = 0
    const g = Et(s.rtl, this.x, this.width)
    const p = function (S) {
  ...
  _updateAnimationTarget (t) {
    ...
    const o = s && s.y
    if (n || o) {
      const a = Ce[t.position].call(
        this,
        this._active,
        this._eventPosition
      )
      if (!a) return
      const r = (this._size = eo(this, t))
  ...
  _positionChanged (t, e) {
    ...
    const a = Ce[o.position].call(this, t, e)
...
const Dc = (i, t) => (i === null ? null : Y(Math.round(i), 0, t))
const he = class extends _t {
  constructor (t) {
    super(t),
...
const Re = class extends de {
  ...
  computeTickLimit () {
    ...
    const s = nt(this.options.ticks.minRotation)
...
function Ac (i, t) {
  ...
  let a = Math.floor(tt(o))
  let r = Math.floor(o / Math.pow(10, a))
  let l = a < 0 ? Math.pow(10, Math.abs(a)) : 1
  do {
...
const Ee = class extends _t {
  ...
  parse (t, e) {
    const s = de.prototype.parse.apply(this, [t, e])
    if (s === 0) {
      this._zero = !0
      return
    }
  ...
  handleTickRangeOptions () {
    ...
    const o = (l) => (s = t ? s : l)
    const a = (l) => (n = e ? n : l)
    const r = (l, c) => Math.pow(10, Math.floor(tt(l)) + c)
...
function Lc (i) {
  ...
  const r = a.centerPointLabels ? B / o : 0
  for (let l = 0; l < o; l++) {
    const c = a.setContext(i.getPointLabelContext(l))
    n[l] = c.padding
    const h = i.getPointPosition(l, i.drawingArea + n[l], r)
    const d = $(c.font)
    const u = Tc(i.ctx, d, i._pointLabels[l])
    s[l] = u
    const f = G(i.getIndexAngle(l) + r)
    const g = Math.round(Ke(f))
    const p = lo(g, h.x, u.w, 0, 180)
    const m = lo(g, h.y, u.h, 90, 270)
    Rc(e, t, f, p, m)
  }
...
function Ec (i, t, e) {
  ...
  const o = i.options
  const a = Ss(o) / 2
  const r = i.drawingArea
  const l = o.pointLabels.centerPointLabels ? B / n : 0
  for (let c = 0; c < n; c++) {
    const h = i.getPointPosition(c, r + a + e[c], l)
    const d = Math.round(Ke(G(h.angle + V)))
    const u = t[c]
    const f = zc(h.y, u.h, d)
    const g = Fc(d)
    const p = Ic(h.x, u.w, g)
    s.push({
      x: h.x,
      y: f,
      textAlign: g,
...
function Bc (i, t) {
  ...
  for (let n = t - 1; n >= 0; n--) {
    ...
    const { backdropColor: g } = o
    if (!T(g)) {
      const p = St(o.borderRadius)
      const m = U(o.backdropPadding)
      e.fillStyle = g
      const b = h - m.left
      const _ = d - m.top
      const v = u - h + m.width
      const y = f - d + m.height
...
const zt = class extends de {
  ...
  setDimensions () {
    const t = (this._padding = U(Ss(this.options) / 2))
...
const Bt = class extends _t {
  ...
  init (t, e) {
    ...
    const n = (this._adapter = new Er._date(t.adapters.date))
    n.init(e),
  ...
  _generate () {
    ...
    const n = this.options
    const o = n.time
    const a = o.unit || ho(o.minUnit, e, s, this._getLabelCapacity(e))
    const r = C(o.stepSize, 1)
  ...
  _tickFormatFunction (t, e, s, n) {
    ...
    const h = l && a[l]
    const d = s[e]
    const u = l && h && d && d.major
    const f = this._adapter.format(t, n || (u ? h : c))
  ...
  _getLabelSize (t) {
    ...
    const n = nt(this.isHorizontal() ? e.maxRotation : e.minRotation)
    const o = Math.cos(n)
    const a = Math.sin(n)
