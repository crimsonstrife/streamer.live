...
const at = (i, t, e, s) =>
  Ke(i, e, s ? (n) => i[n][t] <= e : (n) => i[n][t] < e)
const qs = (i, t, e) => Ke(i, e, (s) => i[s][t] >= e)
function Gs (i, t, e) {
  let s = 0
  let n = i.length
  for (; s < n && i[s] < t;) s++
...
const qe = (i) => (i === 'start' ? 'left' : i === 'end' ? 'right' : 'center')
...
const No = (i) => Si[i & 15]
const Ho = (i) => Si[(i & 240) >> 4] + Si[i & 15]
const Be = (i) => (i & 240) >> 4 === (i & 15)
const jo = (i) => Be(i.r) && Be(i.g) && Be(i.b) && Be(i.a)
function $o (i) {
  const t = i.length
  let e
  return (
...
const Pi = class i {
  ...
  greyscale () {
    const t = this._rgb
    const e = be(t.r * 0.3 + t.g * 0.59 + t.b * 0.11)
...
const Yt = (i, t) => t < i.length && !i[t].skip && i[t]
const gn = (i) => (i === 'x' ? 'y' : 'x')
function Pa (i, t, e, s) {
  const n = i.skip ? t : i
  const o = t
...
const ei = (i) => window.getComputedStyle(i, null)
function Ta (i, t) {
...
function St (i, t) {
  ...
  const a = At(n, 'padding')
  const r = At(n, 'border', 'width')
...
function Fa (i, t, e) {
  ...
  if (t === void 0 || e === void 0) {
    ...
    if (!o) ((t = i.clientWidth), (e = i.clientHeight))
      ...
      const r = ei(o)
      const l = At(r, 'border', 'width')
      const c = At(r, 'padding');
...
function mn (i, t, e, s) {
  const n = ei(i)
  const o = At(n, 'margin')
  const a = Ye(n.maxWidth, i, 'clientWidth') || je
  const r = Ye(n.maxHeight, i, 'clientHeight') || je
  const l = Fa(i, t, e)
  let { width: c, height: h } = l
  if (n.boxSizing === 'content-box') {
    const d = At(n, 'border', 'width')
    const u = At(n, 'padding');
...
const et = class {
  ...
  _resolveAnimations (t, e, s) {
    ...
    const c = new ci(n, l && l.animations)
...
const Dt = class extends et {
  ...
  getLabelAndValue (t) {
    ...
    const o = Zt(e._parsed[t], s.options.locale)
...
const ie = class extends et {
  ...
  updateElements (t, e, s, n) {
    ...
    const m = Lt(g) ? g : Number.POSITIVE_INFINITY
...
const se = class extends et {
  ...
  getLabelAndValue (t) {
    ...
    const s = this.chart
    const n = s.data.labels || []
    const o = Zt(e._parsed[t].r, s.options.locale)
    return { label: n[t] || '', value: o }
  }
...
const Ft = class i extends it {
  ...
  _computeGridLineItems (t) {
    ...
    for (_ = 0; _ < h; _ += q) {
      ...
      const j = P.lineWidth
      const N = P.color
      const Ot = P.borderDash || []
      const bi = P.borderDashOffset
      const Vt = P.tickWidth
      const Ie = P.tickColor
      const Wt = P.tickBorderDash || []
      const de = P.tickBorderDashOffset;
      ((v = kr(this, _, r)),
      v !== void 0 &&
                    ((y = Mt(s, v, j)),
  ...
  _computeLabelItems (t) {
    ...
    for (b = 0, _ = r.length; b < _; ++b) {
      ...
      const j = R / 2
      const N = P.color
      const Ot = P.textStrokeColor
      const bi = P.textStrokeWidth
      let Vt = w
      a
        ? ((x = S),
          w === 'inner' &&
...
const oe = class extends et {
  ...
  updateElements (t, e, s, n) {
    ...
    const b = Lt(p) ? p : Number.POSITIVE_INFINITY
...
function jr (i) {
  ...
  const s = we(Me(t, 'left'), !0)
  const n = we(Me(t, 'right'))
  const o = we(Me(t, 'top'), !0)
  const a = we(Me(t, 'bottom'))
  const r = In(t, 'x')
  const l = In(t, 'y')
  return {
    fullSize: e,
...
const gi = class extends it {
  ...
  adjustHitBoxes () {
    ...
    const a = Rt(o, this.left, this.width)
    if (this.isHorizontal()) {
      let r = 0
  ...
  _draw () {
    ...
    const r = O.color
    const l = Rt(t.rtl, this.left, this.width)
    const c = $(a.font)
...
const fc = {
  ...
  _element: gi,
  start (i, t, e) {
    const s = (i.legend = new gi({ ctx: i.ctx, options: e, chart: i }));
...
function gc (i, t) {
  const e = new Ae({ ctx: i.ctx, options: t, chart: i });
...
const mc = {
  id: 'subtitle',
  start (i, t, e) {
    const s = new Ae({ ctx: i.ctx, options: e, chart: i });
...
function so (i, t, e, s) {
  ...
  const c = n + o
  const { topLeft: h, topRight: d, bottomLeft: u, bottomRight: f } = kt(a)
  let g = vc(t, r)
  const p = Mc(t, l, c)
  return (
    l === 'center'
...
const Te = class extends it {
  ...
  drawBody (t, e, s) {
    ...
    let u = d.lineHeight
    let f = 0
    const g = Rt(s.rtl, this.x, this.width)
    const p = function (S) {
  ...
  _positionChanged (t, e) {
    ...
    const a = Pe[o.position].call(this, t, e)
...
function Ec (i, t, e) {
  ...
  for (let c = 0; c < n; c++) {
    ...
    const d = Math.round(Ue(G(h.angle + V)))
    const u = t[c]
