...
const Th = ['top', 'right', 'bottom', 'left']
function me (s, t, e) {
  const i = {}
  e = e ? '-' + e : ''
  for (let n = 0; n < 4; n++) {
...
function Eh (s, t, e) {
  ...
  if (t === void 0 || e === void 0) {
    ...
    if (!r) (t = s.clientWidth), (e = s.clientHeight)
      ...
      (i = Ti(a.maxWidth, r, 'clientWidth')),
      (n = Ti(a.maxHeight, r, 'clientHeight'))
    }
  }
  return { width: t, height: e, maxWidth: i || Mi, maxHeight: n || Mi }
}
const Tn = (s) => Math.round(s * 10) / 10
function ea (s, t, e, i) {
  const n = Ri(s)
  const r = me(n, 'margin')
  const o = Ti(n.maxWidth, s, 'clientWidth') || Mi
  const a = Ti(n.maxHeight, s, 'clientHeight') || Mi
  const l = Eh(s, t, e)
...
function vo ({ start: s, end: t, count: e, loop: i, style: n }) {
  return {
    start: s % e,
    end: t % e,
    loop: i && (t - s + 1) % e === 0,
...
function ir (s, t, e) {
  ...
  return (
    p !== null &&
            m.push(vo({ start: p, end: u, loop: d, count: o, style: f })),
    m
  )
}
function nr (s, t) {
...
function oa (s, t) {
  ...
  if (i === !0) return To(s, [{ start: o, end: a, loop: r }], e, t)
  const l = a < o ? a + n : a
  const c = !!s._fullLoop && o === 0 && a === n - 1
  return To(s, Ph(e, o, l, c), e, t)
}
function To (s, t, e, i) {
...
const pt = class {
  ...
  _destroy () {
    const t = this._cachedMeta
    this._data && Pn(this._data, this), t._stacked && vs(t)
  }
  ...
  buildOrUpdateElements (t) {
    ...
    e.stack !== i.stack && ((n = !0), vs(e), (e.stack = i.stack)),
...
const $e = class extends pt {
  ...
  _calculateBarValuePixels (t) {
    ...
    if (p === e.getPixelForValue(o)) {
      const y = (vt(m) * e.getLineWidthForValue(o)) / 2;
      (p += y), (m -= y)
    }
...
var Yt = class extends yt {
  ...
  fit () {
    ...
    if (o) {
      ...
      if (
        (a
          ? ((t.width = this.maxWidth), (t.height = Ts(r) + l))
          : ((t.height = this.maxHeight), (t.width = Ts(r) + l)),
...
function Mu (s, t, e) {
  ...
  L.set(t, i),
  s.defaultRoutes && vu(t, s.defaultRoutes),
...
function zi (s, t) {
  let e = Ta.get(s)
  return e || ((e = t()), Ta.set(s, e), al.add(e)), e
}
const Es = (s, t, e) => {
  const i = Bt(t, e)
  i !== void 0 && s.add(i)
...
function kr (s, t, e, i, n, r) {
  ...
  if ((s.beginPath(), r)) {
    ...
    if ((s.lineTo(et.x, et.y), _ > 0)) {
      const Q = He(k, T, o, a)
      s.arc(Q.x, Q.y, _, y - Z, T)
    }
  } else {
    s.moveTo(o, a)
    const E = Math.cos(T) * u + o
    const et = Math.sin(T) * u + a
    s.lineTo(E, et)
...
function Od (s, t, e, i) {
  Td && !t.options.segment ? Md(s, t, e, i) : vd(s, t, e, i)
}
...
function Wd (s, t, e) {
  ...
  for (const a of i) {
    ...
    const u = nr(t, h)
    for (const d of u) {
      const f = vr(e, r[d.start], r[d.end], d.loop)
      const m = ir(a, n, f)
      for (const g of m) {
        o.push({
          source: g,
...
function Na (s, t) {
  ...
  for (const { source: l, target: c, start: h, end: u } of a) {
    ...
    const f = i !== !0
    s.save(), (s.fillStyle = d), sf(s, o, f && vr(n, h, u)), s.beginPath()
...
const Gi = class extends yt {
  ...
  _draw () {
    ...
    const b = function (k, O, T) {
      if (isNaN(g) || g <= 0 || isNaN(p) || p < 0) return
      n.save()
      const F = C(T.lineWidth, 1)
      if (
        ((n.fillStyle = C(T.fillStyle, a)),
        (n.lineCap = C(T.lineCap, 'butt')),
        (n.lineDashOffset = C(T.lineDashOffset, 0)),
        (n.lineJoin = C(T.lineJoin, 'miter')),
        (n.lineWidth = F),
        (n.strokeStyle = C(T.strokeStyle, a)),
        n.setLineDash(C(T.lineDash, [])),
        o.usePointStyle)
      ) {
        const W = {
...
function Tf (s) {
  ...
  for (let l = 0; l < r; l++) {
    ...
    const u = st(c.font)
    const d = vf(s.ctx, u, s._pointLabels[l])
    i[l] = d
...
const _e = class extends Qe {
  ...
  setDimensions () {
    const t = (this._padding = at(Tr(this.options) / 2))
...
var z = class {
  ...
  static resetCaches () {
    P.resetCache(), nt.resetCache(), v.resetCache(), Ml()
  }
}
const rt = class {
  constructor (t, e) {
...
function sc (s) {
  return hs(vm(s), [km, Mm])
}
function ic (s) {
  return hs(s, [Tm, ql], [Om, ql], [Dm, Em])
}
function nc (s) {
  return hs(s, [_m, wm])
}
...
const Gt = class {
  static hasDST (t = z.defaultZone) {
    const e = v.now().setZone(t).set({ month: 12 })
...
let ro = null
function ig () {
  return ro || (ro = v.fromMillis(1555555555555)), ro
}
function ng (s, t) {
...
function gs (s, t, e, i, n, r) {
  ...
  if ((s && Object.keys(s).length !== 0) || t) {
    const l = t || a
    const c = v.fromObject(s, { ...e, zone: l, specificOffset: r })
...
function Sc (s, t) {
  ...
  if (!e.isValid) return v.invalid(pi(e))
  const i = P.fromObject(t)
  let n
  let r
  if (D(s.year)) n = z.now()
  else {
    for (const l of Oc) D(s[l]) && (s[l] = Tc[l])
    const o = Gr(s) || Xr(s)
    if (o) return v.invalid(o)
    const a = hg(e);
    [n, r] = gn(s, a, e)
  }
  return new v({ ts: n, zone: e, loc: i, o: r })
}
function kc (s, t, e) {
...
var v = class {
  ...
  static fromJSDate (t, e = {}) {
    ...
    return n.isValid
      ? new v({ ts: i, zone: n, loc: P.fromObject(e) })
      : v.invalid(pi(n))
  }
  ...
  static fromObject (t, e = {}) {
    ...
    if (!i.isValid) return v.invalid(pi(i))
    ...
    const [k, O] = gn(S, c, i)
    const T = new v({ ts: k, zone: i, o: O, loc: n })
  ...
  static fromFormat (t, e, i = {}) {
    ...
    return h ? v.invalid(h) : gs(a, l, i, `format ${e}`, t, c)
  }
  ...
  setZone (t, { keepLocalTime: e = !1, keepCalendarTime: i = !1 } = {}) {
    ...
    if (t.isValid) {
      ...
      return Te(this, { ts: n, zone: t })
    } else return v.invalid(pi(t))
  }
  ...
  set (t) {
    ...
    return Te(this, { ts: d, o: f })
  }

  plus (t) {
    if (!this.isValid) return this
    const e = I.fromDurationLike(t)
    return Te(this, xc(this, e))
  }
  ...
  toRelative (t = {}) {
    if (!this.isValid) return null
    const e = t.base || v.fromObject({}, { zone: this.zone })
  ...
  toRelativeCalendar (t = {}) {
    return this.isValid
      ? kc(t.base || v.fromObject({}, { zone: this.zone }), this, {
        ...t,
        numeric: 'auto',
  ...
  static fromFormatParser (t, e, i = {}) {
    ...
    return h ? v.invalid(h) : gs(a, l, i, `format ${e.format}`, t, c)
  }
...
function ms (s) {
  ...
  if (s && s.valueOf && Ct(s.valueOf())) return v.fromJSDate(s)
...
function bn ({ cachedData: s, options: t, type: e }) {
  return {
    ...
    getChart: function () {
      return this.$refs.canvas ? Wt.getChart(this.$refs.canvas) : null
    }
  }
}
