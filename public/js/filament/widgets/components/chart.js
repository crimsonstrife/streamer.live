...
const Po = (i, t, e) => Ds(i, e, (s) => i[s][t] >= e)
function No (i, t, e) {
  let s = 0
  let n = i.length
  for (; s < n && i[s] < t;) s++
...
const Ro = ['push', 'pop', 'shift', 'splice', 'unshift']
function Wo (i, t) {
  if (i._chartjs) {
...
const yo = (i, t, e) => Math.pow(2, -10 * i) * Math.sin(((i - t) * H) / e) + 1
var Ie = {
  linear: (i) => i,
  easeInQuad: (i) => i * i,
  easeOutQuad: (i) => -i * (i - 2),
...
const Pc = (i) => vn[i & 15]
const Nc = (i) => vn[(i & 240) >> 4] + vn[i & 15]
const bs = (i) => (i & 240) >> 4 === (i & 15)
const Rc = (i) => bs(i.r) && bs(i.g) && bs(i.b) && bs(i.a)
function Wc (i) {
  const t = i.length
  let e
  return (
...
const On = class i {
  ...
  greyscale () {
    const t = this._rgb
    const e = wi(t.r * 0.3 + t.g * 0.59 + t.b * 0.11)
...
const mh = (i, t) => (i === !0 ? t : typeof i === 'string' ? Vt(t, i) : void 0)
...
const Oh = (i, t, e) => (i > 0 || t > 0) && (!e || !e.shadowRoot)
function Dh (i, t) {
  const e = i.touches
...
function Ah (i, t, e) {
  ...
  const { between: o, normalize: a } = ra(s)
  const l = t.length
...
function sr (i, t, e) {
  ...
  const { property: s, start: n, end: r } = e
  const o = t.length
  const { compare: a, between: l, normalize: c } = ra(s)
  const { start: h, end: u, loop: d, style: f } = Ah(i, t, e)
  const m = []
  let g = !1
  let p = null
  let y
...
function oa (i, t) {
  ...
  if (!n) return []
  const r = !!i._loop
  const { start: o, end: a } = Lh(e, n, r, s)
...
const Hh = Object.keys(A.animation)
...
const or = (i) => i === 'reset' || i === 'none'
const fa = (i, t) => (t ? i : Object.assign({}, i))
const Jh = (i, t, e) =>
...
const gt = class {
  ...
  linkScales () {
    ...
    const r = (e.xAxisID = E(s.xAxisID, rr(t, 'x')))
    const o = (e.yAxisID = E(s.yAxisID, rr(t, 'y')))
    const a = (e.rAxisID = E(s.rAxisID, rr(t, 'r')))
    const l = e.indexAxis
...
function ou (i, t, e, s) {
  ...
  const { start: o, end: a, reverse: l, top: c, bottom: h } = ru(i)
  n === 'middle' &&
        e &&
...
const Be = class extends gt {
  ...
  _calculateBarIndexPixels (t, e) {
    ...
    if (e.grouped) {
      ...
      const h =
                n.barThickness === 'flex' ? iu(t, e, n, c) : eu(t, e, n, c)
...
const yu = (i) => (i === 'left' ? 'right' : i === 'right' ? 'left' : i)
const ya = (i, t, e) => (t === 'top' || t === 'left' ? i[t] + e : i[t] - e)
function ba (i, t) {
  const e = []
  const s = i.length / t
  const n = i.length
  ...
  _computeLabelItems (t) {
    ...
    for (y = 0, b = a.length; y < b; ++y) {
      ...
      if (D.showLabelBackdrop) {
        ...
        const gi = lt.heights[y]
        const xn = lt.widths[y]
        let _n = S + L - De.top
        let wn = x - De.left
        switch (K) {
          case 'middle':
...
function Du (i, t, e, s) {
  ...
  if (a && t === a.axis && t !== 'r' && o && r.length) {
    const l = a._reversePixels ? Po : Ct
    if (s) {
      if (n._sharedOptions) {
        const c = r[0]
...
const Fu = {
  ...
  modes: {
    index (i, t, e, s) {
      ...
      const a = e.intersect ? lr(i, n, r, s, o) : cr(i, n, r, !1, s, o)
      const l = []
      return a.length
    ...
    dataset (i, t, e, s) {
      ...
      const r = e.axis || 'xy'
      const o = e.includeInvisible || !1
      let a = e.intersect ? lr(i, n, r, s, o) : cr(i, n, r, !1, s, o)
      if (a.length > 0) {
...
function Nu (i) {
  ...
  const s = Oi(vi(t, 'left'), !0)
  const n = Oi(vi(t, 'right'))
  const r = Oi(vi(t, 'top'), !0)
  const o = Oi(vi(t, 'bottom'))
  const a = wa(t, 'x')
  const l = wa(t, 'y')
  return {
    fullSize: e,
...
function Ru (i, t, e, s) {
  ...
  const a = Math.max(0, t.outerWidth - Sa(o, i, 'left', 'right'))
  const l = Math.max(0, t.outerHeight - Sa(o, i, 'top', 'bottom'))
  const c = a !== i.w
  const h = l !== i.h
  return (
    (i.w = a),
...
function Ei (i, t, e, s) {
  ...
  for (r = 0, o = i.length, c = 0; r < o; ++r) {
    ...
    const { same: u, other: d } = Ru(t, e, a, s);
...
const Sr = class {
  ...
  createResolver (t, e, s = [''], n) {
    const { resolver: r } = Oa(this._resolverCache, t, s)
...
const xe = class {
  ...
  _handleEvent (t, e, s) {
    ...
    const l = Co(t)
    const c = fd(t, this._lastEvent, s, l)
    s &&
            ((this._lastEvent = null),
...
const Ca = () => V(xe.instances, (i) => i._plugins.invalidate())
const ie = !0
...
function gd (i, t, e, s) {
  const n = md(i.options.borderRadius)
  const r = (e - t) / 2
...
function wd (i, t, e, s) {
  ...
  const { count: o, start: a, loop: l, ilen: c } = dl(n, e, s)
  const h = _d(r)
...
function Sd (i, t, e, s) {
  const n = t.points
  const { count: r, start: o, ilen: a } = dl(n, e, s)
...
function Id (i) {
  ...
  const n = Dd(i, e / 2, s / 2)
  const r = Ed(i, e / 2, s / 2)
  return {
...
const Xe = class extends pt {
  ...
  draw (t) {
    ...
    const { inner: r, outer: o } = Id(this)
    const a = Cd(o.radius) ? Re : Fd
    t.save(),
    (o.w !== r.w || o.h !== r.h) &&
                (t.beginPath(),
                a(t, dr(o, e, r)),
...
const qs = class extends pt {
  ...
  fit () {
    ...
    const { boxWidth: a, itemHeight: l } = za(s, r)
    let c
    let h;
    (e.font = n.string),
    this.isHorizontal()
...
function lf (i, t) {
  const e = new Li({ ctx: i.ctx, options: t, chart: i })
...
const hf = {
  id: 'subtitle',
  start (i, t, e) {
    const s = new Li({ ctx: i.ctx, options: e, chart: i })
...
function Ha (i, t, e) {
  const s = e.yAlign || t.yAlign || df(i, e)
...
const Pi = class extends pt {
  ...
  update (t, e) {
    ...
    if (!n.length) this.opacity !== 0 && (r = { opacity: 0 })
      ...
      const a = Ii[s.position].call(this, n, this._eventPosition);
      ...
      const l = (this._size = Va(this, s))
      const c = Object.assign({}, a, l)
      const h = Ha(this.chart, s, c)
      const u = Ba(s, c, h, this.chart);
  ...
  _positionChanged (t, e) {
    ...
    const o = Ii[r.position].call(this, t, e)
...
const Sf = (i, t) => (i === null ? null : tt(Math.round(i), 0, t))
...
function vf (i) {
  ...
  for (let l = 0; l < r; l++) {
    ...
    const u = Q(c.font)
    const d = Tf(i.ctx, u, i._pointLabels[l])
    s[l] = d
...
function Df (i, t, e) {
  ...
  for (let c = 0; c < n; c++) {
    ...
    const d = t[c]
    const f = Cf(h.y, d.h, u)
    const m = Ef(u)
    const g = If(h.x, d.w, m)
    s.push({
      x: h.x,
      y: f,
      textAlign: m,
...
const _e = class extends Je {
  ...
  setDimensions () {
    const t = (this._padding = rt(vr(this.options) / 2))
...
const we = class extends be {
  ...
  _generate () {
    ...
    const n = this.options
    const r = n.time
    const o = r.unit || Ga(r.minUnit, e, s, this._getLabelCapacity(e))
...
const Vi = { year: M, month: Ot, day: M }
const Er = { year: M, month: Ot, day: M, weekday: Ot }
const Hi = { year: M, month: yt, day: M }
const Bi = { year: M, month: yt, day: M, weekday: yt }
const $i = { hour: M, minute: M }
const ji = { hour: M, minute: M, second: M }
const Ui = { hour: M, minute: M, second: M, timeZoneName: Ot }
const Yi = { hour: M, minute: M, second: M, timeZoneName: yt }
const Zi = { hour: M, minute: M, hourCycle: 'h23' }
const qi = { hour: M, minute: M, second: M, hourCycle: 'h23' }
const Gi = {
  hour: M,
  minute: M,
  second: M,
...
const Ki = { year: M, month: M, day: M, hour: M, minute: M }
const Ji = { year: M, month: M, day: M, hour: M, minute: M, second: M }
const Qi = { year: M, month: Ot, day: M, hour: M, minute: M }
const ts = { year: M, month: Ot, day: M, hour: M, minute: M, second: M }
const Ir = { year: M, month: Ot, day: M, weekday: Ot, hour: M, minute: M }
const es = { year: M, month: yt, day: M, hour: M, minute: M, timeZoneName: Ot }
const is = {
  year: M,
  month: yt,
  day: M,
...
const at = class i extends ut {
  ...
  offset (t) {
    ...
    const s = Vf(this.name)
    let [n, r, o, a, l, c, h] = s.formatToParts ? $f(s, e) : Bf(s, e)
    a === 'BC' && (n = -Math.abs(n) + 1)
    const d = ti({
      year: n,
      month: r,
...
const W = class i {
  ...
  static create (t, e, s, n, r = !1) {
    ...
    const h = os(n) || R.defaultWeekSettings
...
function Gr (i) {
  ...
  const s = bt(i.day, 1, ni(i.year, i.month))
  return t
    ? e
      ? s
        ? !1
...
const st = class i {
  ...
  formatDateTimeFromString (t, e) {
    ...
    const o = (f) =>
      t.isOffsetFixed && t.offset === 0 && f.allowZ
        ...
        : t.isValid
          ...
          : ''
    const a = () =>
      s ? $l(t) : r({ hour: 'numeric', hourCycle: 'h12' }, 'dayperiod')
    const l = (f, m) =>
      s
        ? Ul(t, f)
    ...
    const u = (f) => (s ? Yl(t, f) : r({ era: f }, 'era'))
    const d = (f) => {
      switch (f) {
        case 'S':
...
const io = /(\d\d)(?::?(\d\d)(?::?(\d\d)(?:[.,](\d{1,30}))?)?)?/
const Jl = RegExp(`${io.source}${hm}`)
const so = RegExp(`(?:T${Jl.source})?`)
...
const Ql = RegExp(`${io.source} ?(?:${Kl.source}|(${Gl.source}))?`)
...
const Fm = ai(fm, so)
const Am = ai(Jl)
const tc = li(bm, hi, ds, fs)
const Lm = li(mm, hi, ds, fs)
const Pm = li(gm, hi, ds, fs)
const Nm = li(hi, ds, fs)
function ec (i) {
...
function hc (i, t) {
  ...
  for (const s of $m.slice(1)) t[s] && (e += t[s] * i[s].milliseconds)
  return e
}
function lc (i, t) {
  const e = hc(i, t) < 0 ? -1 : 1
  Te.reduceRight((s, n) => {
    if (O(t[n])) return s
    if (s) {
      const r = t[s] * e
...
var Z = class i {
  ...
  set (t) {
    if (!this.isValid) return this
    const e = { ...this.values, ...ri(t, i.normalizeUnit) }
...
const ms = class {
  ...
  explainFromTokens (t) {
    if (this.isValid) {
      const [e, s] = eg(t, this.regex, this.handlers)
      const [n, r, o] = s ? ig(s) : [null, null, void 0]
      if (ce(s, 'a') && ce(s, 'H')) {
        throw new Tt(
...
function lo (i, t) {
  if (!i) return null
  const s = st.create(t, i).dtFormatter(sg())
...
function Sc (i, t) {
  ...
  if (O(i.year)) n = R.now()
    ...
    for (const l of Oc) O(i[l]) && (i[l] = vc[l])
    const o = Gr(i) || Xr(i)
...
var I = class i {
  ...
  static fromObject (t, e = {}) {
    ...
    const w = g ? Rl(r, o, a) : h ? Wl(r) : Gr(r)
    const x = w || Xr(r)
  ...
  set (t) {
    if (!this.isValid) return this
    const e = ri(t, wc)
    const { minDaysInFirstWeek: s, startOfWeek: n } = qr(e, this.loc)
  ...
  diff (t, e = 'milliseconds', s = {}) {
    ...
    const r = Hl(e).map(Z.normalizeUnit)
