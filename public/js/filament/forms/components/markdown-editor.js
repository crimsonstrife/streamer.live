...
const We = Ke((Yo, Qo) => {
  (function (o, p) {
    ...
    const y = !S && /Chrome\/(\d+)/.exec(o)
    const c = y && +y[1]
    let d = /Opera\//.test(o)
    const k = /Apple Computer/.test(navigator.vendor)
    const z = /Mac OS X 1\d\D([8-9]|\d\d)\D/.test(o)
    const M = /PhantomJS/.test(o)
    const w = k && (/Mobile\/\w+/.test(o) || navigator.maxTouchPoints > 2)
    const W = /Android/.test(o)
    const E =
            w ||
            W ||
            /webOS|BlackBerry|Opera Mini|Opera Mobi|IEMobile/i.test(o)
    const N = w || /Mac/.test(p)
    const G = /\bCrOS\b/.test(o)
    const J = /win/i.test(p)
    let re = d && o.match(/Version\/(\d*\.\d*)/)
    re && (re = Number(re[1])), re && re >= 15 && ((d = !1), (g = !0))
    const q = N && (T || (d && (re == null || re < 12.11)))
    const O = v || (s && h >= 9)
    function D (e) {
    ...
    const Ft = (function () {
      ...
      return function (m, A) {
        ...
        for (let ue = 0, me = j; ue < ee; ++ue) {
          const ve = Y[ue]
          ve == 'm' ? (Y[ue] = me) : (me = ve)
        }
        for (let _e = 0, be = j; _e < ee; ++_e) {
          const Ce = Y[_e]
          Ce == '1' && be == 'r'
            ? (Y[_e] = 'n')
            : a.test(Ce) && ((be = Ce), Ce == 'r' && (Y[_e] = 'R'))
        }
        for (let Ne = 1, Fe = Y[0]; Ne < ee - 1; ++Ne) {
          const $e = Y[Ne]
          $e == '+' && Fe == '1' && Y[Ne + 1] == '1'
            ? (Y[Ne] = '1')
            : $e == ',' &&
        ...
        for (let ut = 0, Dt = j; ut < ee; ++ut) {
          const yt = Y[ut]
          Dt == 'L' && yt == '1'
            ? (Y[ut] = 'L')
            : a.test(yt) && (Dt = yt)
        }
        for (let ft = 0; ft < ee; ++ft) {
          if (i.test(Y[ft])) {
            let ct = void 0
            for (ct = ft + 1; ct < ee && i.test(Y[ct]); ++ct);
            for (
              let lt = (ft ? Y[ft - 1] : j) == 'L',
                qt = (ct < ee ? Y[ct] : j) == 'L',
                pn = lt == qt ? (lt ? 'L' : 'R') : j,
                Sr = ft;
              Sr < ct;
...
`,
    ...
    function va (e, t, n, r, i, a, l) {
      ...
      let j
      const ee = e.options.addModeClass && [null]
    ...
    function io (e, t) {
      ...
      if (u) {
        for (let j = 0; j < u.length; ++j) {
          const ee = u[j]
          if (ee.to == null) {
            const Y = Sn(f, ee.marker)
            Y
              ? m && (ee.to = Y.to == null ? null : Y.to + A)
              : (ee.to = i)
          }
        }
      }
      ...
      for (var i = [{ from: t, to: n }], a = 0; a < r.length; ++a) {
        for (let l = r[a], u = l.find(0), f = 0; f < i.length; ++f) {
          ...
          if (!(ye(m.to, u.from) < 0 || ye(m.from, u.to) > 0)) {
            const A = [f, 1]
            const j = ye(m.from, u.from)
            const ee = ye(m.to, u.to);
      ...
      if (l) {
        for (let u = 0; u < l.length; ++u) {
          ...
          if (f.marker.collapsed) {
            ...
            const j = ye(m.to, r) || oi(f.marker) - oi(i)
            if (
              !((A >= 0 && j <= 0) || (A <= 0 && j >= 0)) &&
                            ((A <= 0 &&
    ...
    function Ca (e, t) {
      ...
      for (let i = 0; i <= (t.rest ? t.rest.length : 0); i++) {
        ...
        (r.map = [])
        const u = t != e.display.externalMeasured && _(a)
        $c(a, r, da(e, a, u)),
        a.styleClasses &&
      ...
      if (t) {
        ...
        if (!f.test(t)) {
          ...
          for (let j = 0; ;) {
            f.lastIndex = j
            const ee = f.exec(t)
            const Y = ee ? ee.index - j : t.length - j
            if (Y) {
              const ie = document.createTextNode(
                u.slice(j, j + Y)
              )
              s && h < 9
                ? A.appendChild(x('span', [ie]))
                : A.appendChild(ie),
...
`
    ...
    function Ia (e) {
      ...
      const t = V(e.measure, x('pre', 'x', 'CodeMirror-line-like'))
    ...
    function of (e, t, n, r) {
      ...
      if (s && h < 9 && !l && (!m || (!m.left && !m.right))) {
        const ee = a.parentNode.getClientRects()[0]
        ee
          ? (m = {
              left: ee.left,
    ...
    function mo (e, t, n) {
      ...
      for (let l = Ae(r, i); ;) {
        ...
        const f = Fc(l, u.ch + (u.xRel > 0 || u.outside > 0 ? 1 : 0))
        if (!f) return u
        const m = f.find(1)
    ...
    function lf (e, t, n, r, i) {
      ...
      if (A) {
        const j = (e.options.lineWrapping ? uf : sf)(
          e,
          t,
          n,
          a,
    ...
    function Jr (e) {
      ...
      const t = x('span', 'xxxxxxxxxx')
      const n = x('pre', [t], 'CodeMirror-line-like')
      V(e.measure, n)
    ...
    function Mr (e, t, n, r) {
      ...
      if (
        ...
        f = ne(
          ...
          Math.max(
            0,
            Math.round((a - Ia(e.display).left) / Jr(e.display)) -
                            A
          )
        )
      }
    ...
    function _o (e, t, n) {
      ...
      const i = n.appendChild(x('div', '\xA0', 'CodeMirror-cursor'))
      if (
    ...
    function ff (e, t, n) {
        ...
        function Ot (ut, Dt, yt) {
          ...
          const lt =
                        yt == 'after'
                          ? ft.begin
                          : ft.end -
                              (/\s/.test(Fe.text.charAt(ft.end - 1)) ? 2 : 1)
          return rt(lt, ct)[ct]
        }
        const At = Pe(Fe, i.direction)
        return (
      ...
      if (ee.line == Y.line) j(ee.line, ee.ch, Y.ch)
        ...
        const ie = Ae(i, ee.line)
        const ue = Ae(i, Y.line)
        const me = Zt(ie) == Zt(ue)
        const ve = j(
          ee.line,
          ee.ch,
          me ? ie.text.length + 1 : null
        ).end
        const _e = j(Y.line, me ? 0 : null, Y.ch).start
        me &&
                    (ve.top < _e.top - 2
      ...
      for (
        ...
        if (!u.hidden) {
          if (((i += u.line.height), s && h < 8)) {
            const j = u.node.offsetTop + u.node.offsetHeight;
            (m = j - n), (n = j)
          } else {
            const ee = u.node.getBoundingClientRect();
            (m = ee.bottom - ee.top),
            !f &&
                                u.text.firstChild &&
                                (A =
    ...
    function gi (e, t, n) {
      ...
      if (n && n.ensure) {
        ...
        u < a
          ? ((a = u),
            (l = P(t, ar(Ae(t, u)) + e.wrapper.clientHeight)))
          : Math.min(f, t.lastLine()) >= l &&
                      ((a = P(t, ar(Ae(t, f)) - e.wrapper.clientHeight)),
                      (l = f))
      }
    ...
    function To (e, t) {
      ...
      const j = e.options.fixedGutter ? 0 : n.gutters.offsetWidth
      const ee =
    ...
    function _f (e) {
      ...
      const n = e.focus && e.focus == H(de(t))
      e.preparedSelection &&
      ...
      if (!(t.highlightFrontier >= e.display.viewTo)) {
        ...
        t.iter(
          ...
          function (a) {
            ...
            if (+new Date() > n) {
              return Fn(e, e.options.workDelay), !0
            }
          }
        ),
      ...
      for (let f = r.view, m = r.viewFrom, A = 0; A < f.length; A++) {
        ...
        if (!j.hidden) {
          if (!j.node || j.node.parentNode != a) {
            ...
            for (; l != j.node;) l = u(l)
            let Y = i && t != null && t <= m && j.lineNumber
            j.changes &&
                            (Se(j.changes, 'gutter') > -1 && (Y = !1),
                            Ma(e, j, m, n)),
            Y &&
                                (R(j.lineNumber),
    ...
    function ll (e) {
      ...
      for (let r = 0; r < n.length; ++r) {
        ...
        const u = t.appendChild(
          x('div', null, 'CodeMirror-gutter ' + a)
        )
        l && (u.style.cssText = l),
        a == 'CodeMirror-linenumbers' &&
                        ((e.lineGutter = u),
      ...
      for (let a = 1; a < t.length; a++) {
        ...
        if (r && !l.empty() ? f > 0 : f >= 0) {
          ...
          const j = u.empty()
            ...
            : u.from() == u.head
          a <= n && --n,
          t.splice(--a, 2, new Ye(j ? A : m, j ? m : A))
        }
      }
      return new Rt(t, n)
    }
...
`
    ...
    function Vf (e, t, n, r) {
      ...
      if (e.doc.direction == 'rtl' || l.level == 1) {
        const j = (l.level == 1) == r < 0
        const ee = u(n, j ? 1 : -1)
        if (
          ee != null &&
                    (j
                      ? ee <= l.to && ee <= A.end
                      : ee >= l.from && ee >= A.begin)
        ) {
          const Y = j ? 'before' : 'after'
      ...
      const ie = function (ve, _e, be) {
        for (
          ...
          const Ne = i[ve]
          const Fe = _e > 0 == (Ne.level != 1)
          let $e = Fe ? be.begin : u(be.end, -1)
          if (
            (Ne.from <= $e && $e < Ne.to) ||
...
`,
    ...
    function ld (e, t, n) {
      ...
      const i = r ? r(e, t, n) : {}
      if (i.unit == null) {
        const a = G ? n.shiftKey && n.metaKey : n.altKey
        i.unit = a
          ? 'rectangle'
          : t == 'single'
            ? 'char'
    ...
    function fd (e, t) {
      ...
      if (r.line != n.line) {
        ...
        const j = A - l || (r.ch - n.ch) * (u.level == 1 ? -1 : 1)
        A == f - 1 || A == f ? (m = j < 0) : (m = j > 0)
      }
      const ee = a[f + (m ? -1 : 0)]
      const Y = m == (ee.level == 1)
      const ie = Y ? ee.from : ee.to
    ...
    function Vl (e, t, n, r) {
      ...
      for (let f = 0; f < e.display.gutterSpecs.length; ++f) {
        ...
        if (m && m.getBoundingClientRect().right >= i) {
          const A = P(e.doc, a)
          const j = e.display.gutterSpecs[f]
    ...
    function Xn (e, t, n, r) {
      ...
      if (e.options.indentWithTabs) {
        for (let Y = Math.floor(A / l); Y; --Y) (ee += l), (j += '	')
      }
        ...
        indentSelection: Tt(function (r) {
          for (
            ...
            if (u.empty()) {
              ...
              for (let j = A; j < a; ++j) Xn(this, j, r)
              const ee = this.doc.sel.ranges
              f.ch == 0 &&
                                i.length == ee.length &&
                                ee[l].from().ch > 0 &&
        ...
        moveV: Tt(function (r, i) {
          ...
          if (
            (l.extendSelectionsBy(function (A) {
              ...
              const j = Xt(a, A.head, 'div')
              A.goalColumn != null && (j.left = A.goalColumn),
              u.push(j.left)
              const ee = as(a, j, r, i)
              return (
                i == 'page' &&
...
`))
    ...
    (Qe.prototype.showPrimarySelection = function () {
      ...
      if (
        ...
        if (!m) {
          ...
          const j = A.maps ? A.maps[A.maps.length - 1] : A.map
          m = {
            node: j[j.length - 1],
        ...
        const ee = e.rangeCount && e.getRangeAt(0)
        let Y
        try {
    ...
    (Qe.prototype.pollContent = function () {
      ...
      const Ne = ne(l, Y)
      const Fe = ne(m, ee.length ? ce(ee).length - ie : 0)
    ...
    function xd (e, t, n) {
      ...
      let i = !1
      if (!t || !I(r, t)) return dn(ne(_(e.line), 0), !0)
      ...
      function A (me, ve, _e) {
        for (let be = -1; be < (m ? m.length : 0); be++) {
          for (
            ...
            const Fe = Ce[Ne + 2]
            if (Fe == me || Fe == ve) {
              const $e = _(be < 0 ? e.line : e.rest[be])
              let Ve = Ce[Ne] + _e
              return (
                (_e < 0 || Fe != me) &&
                                    (Ve = Ce[Ne + (_e ? 1 : 0)]),
      ...
      if (j) return dn(j, i)
      for (
        let ee = u.nextSibling, Y = l ? l.nodeValue.length - n : 0;
        ee;
        ee = ee.nextSibling
      ) {
...
`) > -1
    ...
    function _d (e, t) {
      ...
      if (
        e.form &&
                (Ie(e.form, 'submit', r), !t.leaveSubmitMethodAlone)
      ) {
        const a = e.form
        i = a.submit
        try {
  ...
  (function (o) {
    ...
    o.commands.newlineAndIndentContinueMarkdownList = function (S) {
      ...
      for (var s = S.listSelections(), h = [], g = 0; g < s.length; g++) {
        const T = s[g].head
        let y = S.getStateAfter(T.line)
        const c = o.innerMode(S.getMode(), y)
        if (
        ...
        const d = y.list !== !1
        const k = y.quote !== 0
        const z = S.getLine(T.line)
        const M = p.exec(z)
        const w = /^\s*$/.test(z.slice(0, T.ch))
...
`)
          ...
          const N = M[1]
          const G = M[5]
          const J = !(C.test(M[2]) || M[2].indexOf('>') >= 0)
          const re = J
...
` +
    ...
    function b (S, s) {
      ...
      do {
        ...
        if (z) {
          const M = z[1]
          const w = parseInt(y[3], 10) + g - T
          const W = parseInt(z[3], 10)
          let E = W
          if (c === M && !isNaN(W)) {
            w === W && (E = W + 1),
            w > W && (E = w + 1),
...
const ys = Ke((vs, bs) => {
  (function (o) {
    ...
    o.defineOption('styleSelectedText', !1, function (y, c, d) {
      ...
      c && !k
        ...
        : !c &&
                  ...
                  y.off('change', v),
                  h(y),
                  (y.state.markedSelection = y.state.markedSelectionStyle =
                      null))
    })
    function p (y) {
      y.state.markedSelection &&
    ...
    function s (y, c, d, k) {
      if (S(c, d) != 0) {
        for (
          let z = y.state.markedSelection,
            M = y.state.markedSelectionStyle,
            w = c.line;
          ;

        ) {
          const W = w == c.line ? c : b(w, 0)
          const E = w + C
          const N = E >= d.line
          const G = N ? d : b(E, 0)
          const J = y.markText(W, G, { className: M })
          if ((k == null ? z.push(J) : z.splice(k++, 0, J), N)) break
          w = E
        }
      }
    }
    ...
    function g (y) {
      h(y)
      for (let c = y.listSelections(), d = 0; d < c.length; d++) {
        s(y, c[d].from(), c[d].to())
      }
    }
    function T (y) {
      ...
      const c = y.getCursor('start')
      const d = y.getCursor('end')
      const k = y.state.markedSelection
      if (!k.length) return s(y, c, d)
      let z = k[0].find()
      let M = k[k.length - 1].find()
      if (
        !z ||
                !M ||
                d.line - c.line <= C ||
...
const ks = Ke((xs, _s) => {
  (function (o) {
    ...
    function C (w, W) {
      for (var E = v(w), N = E, G = 0; G < W.length; G++) {
        N.indexOf(W.charAt(G)) == -1 && (N += W.charAt(G))
      }
    ...
    function S (w, W, E) {
      W = C(W, 'g')
      for (
        let N = E.line, G = E.ch, J = w.lastLine();
        N <= J;
        N++, G = 0
      ) {
        W.lastIndex = G
        const re = w.getLine(N)
        const q = W.exec(re)
        if (q) {
          return {
            from: p(N, q.index),
    ...
    function s (w, W, E) {
      ...
      W = C(W, 'gm')
      for (var N, G = 1, J = E.line, re = w.lastLine(); J <= re;) {
        for (let q = 0; q < G && !(J > re); q++) {
          const O = w.getLine(J++)
          N =
                        N == null
                          ? O
...
` +
        ...
        const D = W.exec(N)
        if (D) {
          const Q = N.slice(0, D.index).split(`
`)
          const R = D[0].split(`
`)
          const V = E.line + Q.length - 1
          const x = Q[Q.length - 1].length
          return {
            from: p(V, x),
            to: p(
              V + R.length - 1,
    ...
    function h (w, W, E) {
      for (var N, G = 0; G <= w.length;) {
        W.lastIndex = G
        const J = W.exec(w)
        if (!J) break
        const re = J.index + J[0].length
    ...
    function g (w, W, E) {
      W = C(W, 'g')
      for (
        let N = E.line, G = E.ch, J = w.firstLine();
        N >= J;
        N--, G = -1
      ) {
        const re = w.getLine(N)
        const q = h(re, W, G < 0 ? 0 : re.length - G)
        if (q) {
          return {
            from: p(N, q.index),
            to: p(N, q.index + q[0].length),
    ...
    function T (w, W, E) {
      ...
      for (
        ...
        for (let O = 0; O < G && re >= q; O++) {
          const D = w.getLine(re--)
          N =
                        N == null
                          ? D
                          : D +
...
` +
        ...
        const Q = h(N, W, J)
        if (Q) {
          const R = N.slice(0, Q.index).split(`
`)
          const V = Q[0].split(`
`)
          const x = re + R.length
          const K = R[R.length - 1].length
          return {
            from: p(x, K),
            to: p(
              x + V.length - 1,
    ...
    function d (w, W, E, N) {
      ...
      for (let G = 0, J = E + Math.max(0, w.length - W.length); ;) {
        if (G == J) return G
        const re = (G + J) >> 1
        const q = N(w.slice(0, re)).length
        if (q == E) return re
        q > E ? (J = re) : (G = re + 1)
      }
    }
    function k (w, W, E, N) {
      ...
      const J = G(W).split(/\r|\n\r?/)
      e: for (
        let re = E.line, q = E.ch, O = w.lastLine() + 1 - J.length;
        re <= O;
        re++, q = 0
      ) {
        const D = w.getLine(re).slice(q)
        const Q = G(D)
        if (J.length == 1) {
          const R = Q.indexOf(J[0])
          if (R == -1) continue e
          var E = d(D, Q, R, G) + q
          return {
    ...
    function z (w, W, E, N) {
      ...
      const J = G(W).split(/\r|\n\r?/)
      e: for (
        let re = E.line, q = E.ch, O = w.firstLine() - 1 + J.length;
        re >= O;
        re--, q = -1
      ) {
        let D = w.getLine(re)
        ...
        if (J.length == 1) {
          ...
          for (
            var x = 1, E = re - J.length + 1;
            x < J.length - 1;
            x++
          ) {
            if (G(w.getLine(E + x)) != J[x]) continue e
          }
          const K = w.getLine(re + 1 - J.length)
          const X = G(K)
          if (X.slice(X.length - J[0].length) != J[0]) continue e
          return {
            from: p(
              re + 1 - J.length,
              d(K, X, K.length - J[0].length, G)
            ),
    ...
    function M (w, W, E, N) {
      ...
      let G
      typeof N === 'object' ? (G = N.caseFold) : ((G = N), (N = null)),
      typeof W === 'string'
        ? (G == null && (G = !1),
    ...
    (M.prototype = {
      ...
      find: function (w) {
        let W = this.doc.clipPos(w ? this.pos.from : this.pos.to)
        if (
        ...
        return (
          (this.pos = { from: N, to: N }), (this.atOccurrence = !1)
        )
      },
      from: function () {
...
const Vo = Ke((ws, Ss) => {
  (function (o) {
    ...
    function v (I, H, le, xe) {
      let F = I.indented
      return (
        I.context &&
                    I.context.type == 'statement' &&
                    le != 'statement' &&
                    (F = I.context.indented),
        (I.context = new p(F, H, le, xe, null, I.context))
      )
    }
    function C (I) {
      const H = I.context.type
      return (
        (H == ')' || H == ']' || H == '}') &&
    ...
    function b (I, H, le) {
      if (
        H.prevToken == 'variable' ||
                ...
                (H.typeAtEndOfLine && I.column() == I.indentation())
      ) {
        return !0
      }
    }
    ...
    o.defineMode('clike', function (I, H) {
      const le = I.indentUnit
      const xe = H.statementIndentUnit || le
      const F = H.dontAlignCalls
      const L = H.keywords || {}
      const de = H.types || {}
      const ze = H.builtin || {}
      const pe = H.blockKeywords || {}
      const Ee = H.defKeywords || {}
      const ge = H.atoms || {}
      const Oe = H.hooks || {}
      const qe = H.multiLineStrings
      const Se = H.indentStatements !== !1
      const je = H.indentSwitch !== !1
      const Ze = H.namespaceSeparator
      const ke = H.isPunctuationChar || /[\[\]{}\(\),;\:\.]/
      const Je = H.numberStart || /[\d\.]/
      const He =
                H.number ||
                /^(?:0x[a-f\d]+|0b[01]+|(?:\d+\.?\d*|\.\d+)(?:e[-+]?\d+)?)(u|ll?|l|f)?/i
      const Ge = H.isOperatorChar || /[+\-*&%=<>!?|\/]/
      const U = H.isIdentifierChar || /[\w\$_\xa1-\uffff]/
      const Z = H.isReservedIdentifier || !1
      let ce
      let Be
      function te (we, Me) {
        const Le = we.next()
    ...
    function s (I) {
      for (var H = {}, le = I.split(' '), xe = 0; xe < le.length; ++xe) {
        H[le[xe]] = !0
      }
      return H
    }
    function h (I, H) {
      return typeof I === 'function' ? I(H) : I.propertyIsEnumerable(H)
    }
    const g =
    ...
    const k = s('SEL instancetype id Class Protocol BOOL')
    function z (I) {
    ...
    const w = 'case do else for if switch while struct enum union'
    const W = 'struct enum union'
    function E (I, H) {
    ...
    function D (I, H) {
      const le = H.cpp11RawStringDelim.replace(/[^\w\s]/g, '\\$&')
      const xe = I.match(new RegExp('.*?\\)' + le + '"'))
      return xe ? (H.tokenize = null) : I.skipToEnd(), 'string'
    }
    function Q (I, H) {
      typeof I === 'string' && (I = [I])
      const le = []
      ...
      for (let F = 0; F < I.length; ++F) o.defineMIME(I[F], H)
    }
        ...
        for (var xe; (xe = H.next());) {
          if (xe == '*' && H.eat('/')) {
            if (I == 1) {
              ...
              return (le.tokenize = V(I - 1)), le.tokenize(H, le)
            }
          } else if (xe == '/' && H.eat('*')) {
            return (le.tokenize = V(I + 1)), le.tokenize(H, le)
          }
    ...
    Q('text/x-kotlin', {
      ...
      hooks: {
        ...
        '"': function (I, H) {
          return (H.tokenize = x(I.match('""'))), H.tokenize(I, H)
        },
        '/': function (I, H) {
          return I.eat('*')
            ? ((H.tokenize = V(1)), H.tokenize(I, H))
        ...
        indent: function (I, H, le, xe) {
          const F = le && le.charAt(0)
          if (
          ...
          if (
            (I.prevToken == 'operator' &&
                            le != '}' &&
                            I.context.type != '}') ||
                        (I.prevToken == 'variable' && F == '.') ||
                        ((I.prevToken == '}' || I.prevToken == ')') && F == '.')
          ) {
    ...
    Q('text/x-ceylon', {
      ...
      hooks: {
        ...
        '"': function (I, H) {
          return (
            (H.tokenize = X(I.match('""') ? 'triple' : 'single')),
            H.tokenize(I, H)
          )
        },
        '`': function (I, H) {
          return !K || !I.match('`')
            ? !1
            : ((H.tokenize = K), (K = null), H.tokenize(I, H))
        },
        "'": function (I) {
...
const gn = Ke((Es, zs) => {
  (function (o) {
    ...
    o.defineMode('css', function (O, D) {
      ...
      const ge = O.highlightNonStandardPropertyKeywords !== !1
      let Oe
      let qe
      function Se (te, fe) {
        return (Oe = fe), te
    ...
    o.defineMIME('text/css', {
      ...
      tokenHooks: {
        '/': function (O, D) {
          return O.eat('*') ? ((D.tokenize = q), q(O, D)) : !1
        }
      },
      name: 'css'
    }),
    o.defineMIME('text/x-scss', {
      ...
      tokenHooks: {
        ...
        ':': function (O) {
          return O.match(/^\s*\{/, !1) ? [null, null] : !1
        },
        $: function (O) {
          return (
            O.match(/^[\w-]+/),
  ...
  (function (o) {
    ...
    o.defineMode('xml', function (C, b) {
      ...
      function M (x) {
        return function (K, X) {
          for (var I; (I = K.next()) != null;) {
            if (I == '<') {
              return (X.tokenize = M(x + 1)), X.tokenize(K, X)
            }
            if (I == '>') {
              if (x == 1) {
                X.tokenize = c
                ...
                return (
                  (X.tokenize = M(x - 1)), X.tokenize(K, X)
                )
              }
            }
          }
      ...
      function D (x, K, X) {
        ...
        if (x == 'endTag' || x == 'selfcloseTag') {
          ...
          return (
            ...
            x == 'selfcloseTag' ||
                        s.autoSelfClosers.hasOwnProperty(w(I))
              ? N(X, I)
              : (N(X, I),
                (X.context = new W(X, I, H == X.indented))),
            G
          )
        }
        return (y = 'error'), D
      ...
      function Q (x, K, X) {
        return x == 'equals'
          ? R
          : (s.allowMissing || (y = 'error'), D(x, K, X))
      }
      function R (x, K, X) {
        return x == 'string'
          ? V
      ...
      return {
        ...
        token: function (x, K) {
          if (
            (!K.tagName &&
                            x.sol() &&
                            (K.indented = x.indentation()),
            x.eatSpace())
          ) {
            return null
          }
          T = null
          let X = K.tokenize(x, K)
          return (
            (X || T) &&
                            X != 'comment' &&
                            ((y = null),
          ...
          if (H && H[1]) {
            for (; I;) {
              if (I.tagName == H[2]) {
                ...
                s.implicitlyClosed.hasOwnProperty(w(I.tagName))
              ) {
                I = I.prev
              } else break
            }
            ...
            for (; I;) {
              const le = s.contextGrabbers[w(I.tagName)]
              if (le && le.hasOwnProperty(w(H[2]))) I = I.prev
              else break
            }
          }
          for (; I && I.prev && !I.startOfLine;) I = I.prev
          return I ? I.indent + S : x.baseIndent || 0
        },
        electricInput: /<\/[\s\w:]+>$/,
        blockCommentStart: '<!--',
        blockCommentEnd: '-->',
        ...
        xmlCurrentContext: function (x) {
          for (var K = [], X = x.context; X; X = X.prev) {
            K.push(X.tagName)
          }
          return K.reverse()
        }
  ...
  (function (o) {
    ...
    o.defineMode('javascript', function (p, v) {
      ...
      const y = (function () {
        ...
        const P = _('keyword a')
        const ae = _('keyword b')
        const he = _('keyword c')
        const ne = _('keyword d')
        const ye = _('operator')
      ...
      function re (_, P) {
        ...
        let ae = _.string.indexOf('=>', _.start)
        if (!(ae < 0)) {
          if (g) {
            const he =
                            /:\s*(?:\w+(?:<[^>]*>|\[\])?|\{[^}]*\})\s*$/.exec(
          ...
          for (var ne = 0, ye = !1, Xe = ae - 1; Xe >= 0; --Xe) {
            const pt = _.string.charAt(Xe)
            const Et = J.indexOf(pt)
            if (Et >= 0 && Et < 3) {
              if (!ne) {
                ++Xe
                break
      ...
      function D (_, P) {
        ...
        for (let he = _.context; he; he = he.prev) {
      ...
      function V () {
        for (let _ = arguments.length - 1; _ >= 0; _--) {
          R.cc.push(arguments[_])
        }
      }
      function x () {
      ...
      function K (_, P) {
        for (let ae = P; ae; ae = ae.next) if (ae.name == _) return !0
        return !1
      }
      function X (_) {
        const P = R.state
      ...
      function I (_, P) {
        if (P) {
          if (P.block) {
            ...
            return K(_, P.vars)
              ? P
              : new le(P.prev, new xe(_, P.vars), !1)
          }
        } else return null
      }
      function H (_) {
      ...
      const F = new xe('this', new xe('arguments', null))
      function L () {
        (R.state.context = new le(
          R.state.context,
          R.state.localVars,
          !1
        )),
                    ...
                    : _ == ';'
                      ...
                      : _ == 'if'
                        ? (R.state.lexical.info == 'else' &&
                                        R.state.cc[R.state.cc.length - 1] ==
                                            Ee &&
                                        R.state.cc.pop()(),
      ...
      function Ge (_, P, ae) {
        ...
        if (_ != ';') {
          ...
          if (g && P == 'as') {
            return (R.marked = 'keyword'), x(Pe, he)
          }
          if (_ == 'regexp') {
            return (
      ...
      function Z (_) {
        if (_ == '}') {
          return (
            (R.marked = 'string-2'), (R.state.tokenize = G), x(U)
          )
        }
      }
      function ce (_) {
      ...
      function Me (_, P) {
        ...
        if (_ == 'variable' || R.style == 'keyword') {
          if (((R.marked = 'property'), P == 'get' || P == 'set')) {
            return x(Le)
          }
          let ae
          return (
          ...
          if (_ == 'number' || _ == 'string') {
            return (
              (R.marked = S ? 'property' : R.style + ' property'),
              x($)
            )
          }
      ...
      function Pt (_) {
        if (g && _ == ':') {
          return R.stream.match(/^\s*\w+\s+is\b/, !1)
            ? x(Se, Ft, Pe)
            : x(Pe)
        }
      }
      ...
      function it (_) {
        if (_ == '}') {
          return (
            (R.marked = 'string-2'), (R.state.tokenize = G), x(_t)
          )
        }
      }
      function ot (_, P) {
      ...
      return {
        ...
        indent: function (_, P) {
          if (_.tokenize == N || _.tokenize == G) return o.Pass
          if (_.tokenize != W) return 0
          const ae = P && P.charAt(0)
          let he = _.lexical
          let ne
          if (!/^\s*else\b/.test(P)) {
            for (let ye = _.cc.length - 1; ye >= 0; --ye) {
              const Xe = _.cc[ye]
              if (Xe == Ee) he = he.prev
...
const Qn = Ke((Os, Ps) => {
  (function (o) {
    ...
    function h (T, y) {
      for (const c in T) {
        for (
          let d = y[c] || (y[c] = []), k = T[c], z = k.length - 1;
          z >= 0;
          z--
        ) {
          d.unshift(k[z])
    ...
    o.defineMode(
      ...
      function (T, y) {
        ...
        function w (W, E) {
          const N = c.token(W, E.htmlState)
          const G = /\btag\b/.test(N)
          let J
          if (
            G &&
                        !/[<>\s\/]/.test(W.current()) &&
            ...
            const re = /^([\S]+) (.*)/.exec(E.inTag)
            E.inTag = null
            const q = W.current() == '>' && g(d[re[1]], re[2])
            const O = o.getMode(T, q)
            const D = s(re[1], !0)
            const Q = s(re[1], !1);
  ...
  (function (o) {
    ...
    (o.simpleMode = function (y, c) {
      ...
      const G = {
        ...
        copyState: function (re) {
          ...
          for (let O = re.persistentStates; O; O = O.next) {
            q.persistentStates = {
              mode: O.mode,
              spec: O.spec,
              state:
                                    O.state == re.localState
                                      ? q.localState
                                      : o.copyState(O.mode, O.state),
      ...
      if (k) for (const J in k) k.hasOwnProperty(J) && (G[J] = k[J])
      return G
    })
    function p (y, c) {
    ...
    function S (y, c) {
      return function (d, k) {
        ...
        for (let W = y[k.state], E = 0; E < W.length; E++) {
          const N = W[E]
          const G = (!N.data.sol || d.sol()) && d.match(N.regex)
          if (G) {
            N.data.next
              ? (k.state = N.data.next)
              : N.data.push
                ...
                : N.data.pop &&
                                ...
                                k.stack.length &&
                                (k.state = k.stack.pop()),
            N.data.mode && h(c, k, N.data.mode, N.token),
            N.data.indent &&
                                k.indent.push(d.indentation() + c.indentUnit),
            N.data.dedent && k.indent.pop()
            let J = N.token
            if (
              (J && J.apply && (J = J(G)),
              G.length > 2 &&
    ...
    function s (y, c) {
      if (y === c) return !0
      if (!y || typeof y !== 'object' || !c || typeof c !== 'object') {
        return !1
      }
      let d = 0
      for (var k in y) {
    ...
    function h (y, c, d, k) {
      let z
      if (d.persistent) {
        for (let M = c.persistentStates; M && !z; M = M.next) {
          (d.spec ? s(d.spec, M.spec) : d.mode == M.mode) && (z = M)
        }
      }
      const w = z ? z.mode : d.mode || o.getMode(y, d.spec)
      const W = z ? z.state : o.startState(w)
      d.persistent &&
                !z &&
                (c.persistentStates = {
                  mode: w,
    ...
    function g (y, c) {
      for (let d = 0; d < c.length; d++) if (c[d] === y) return !0
    }
    function T (y, c) {
  ...
  (function (o) {
    ...
    o.defineMode(
      ...
      function (p, v) {
        ...
        function S (F) {
          if (o.findModeByName) {
            const L = o.findModeByName(F)
            L && (F = L.mime || L.mimes[0])
          }
          const de = o.getMode(p, F)
        ...
        function J (F) {
          if (
            ...
            let L = b
            if (!L) {
              const de = o.innerMode(C, F.htmlState)
              L =
                                de.mode.name == 'xml' &&
        ...
        function re (F, L) {
          const de = F.column() === L.indentation
          const ze = G(L.prevLine.stream)
          ...
          if (
            ...
            if (F.peek() === '[') return E(F, L, I)
          }
          return E(F, L, L.inline)
        }
        function q (F, L) {
          const de = C.token(F, L.htmlState)
          if (!b) {
        ...
        function D (F) {
          ...
          if (F.formatting) {
            ...
            for (let de = 0; de < F.formatting.length; de++) {
          ...
          if (
            ...
            const ze = (F.listStack.length - 1) % 3
            ze
              ? ze === 1
                ? L.push(s.list2)
                : L.push(s.list3)
        ...
        function R (F, L) {
          ...
          if (
            ...
            const ke = F.string.indexOf('>', F.pos)
            if (ke != -1) {
              const Je = F.string.substring(F.start, ke);
        ...
        var xe = {
          ...
          copyState: function (F) {
            return {
              ...
              block: F.block,
              htmlState:
                                F.htmlState && o.copyState(C, F.htmlState),
          ...
          token: function (F, L) {
            if (((L.formatting = !1), F != L.thisLine.stream)) {
              ...
              if (
                ...
                const de = F.match(/^\s*/, !0)[0].replace(
                  /\t/g,
                  W
                ).length
                if (
      ...
      function (C, b) {
        ...
        function T (c, d, k) {
          ...
          if (c.peek() == '{') {
            ...
            let z = h(k.state)
            let M = k.state.context
            if (M && c.match(/^[^>]*>\s*$/, !1)) {
              for (; M.prev && !M.startOfLine;) M = M.prev
              M.startOfLine
                ? (z -= C.indentUnit)
                : k.prev.state.lexical &&
                                  (z = k.prev.state.lexical.indented)
  ...
  (function (o) {
    ...
    o.defineMode('nginx', function (p) {
      ...
      function T (k, z) {
        ...
        const w = k.next()
        if (w == '@') {
          return k.eatWhile(/[\w\\\-]/), g('meta', k.current())
        }
      ...
      return {
        ...
        token: function (k, z) {
          ...
          h = null
          let M = z.tokenize(k, z)
          const w = z.stack[z.stack.length - 1]
          return (
            h == 'hash' && w == 'rule'
              ? (M = 'atom')
              : M == 'variable' &&
        ...
        indent: function (k, z) {
          let M = k.stack.length
          return (
            /^\}/.test(z) &&
                            (M -=
                                k.stack[k.stack.length - 1] == 'rule' ? 2 : 1),
            k.baseIndent + M * s
          )
        },
        electricChars: '}'
  ...
  (function (o) {
    ...
    o.defineMode('pascal', function () {
      ...
      function S (T, y) {
        ...
        if (c == '"' || c == "'") {
          return (y.tokenize = s(c)), y.tokenize(T, y)
        }
  ...
  (function (o) {
    ...
    function v (T, y, c) {
      return T.length == 0
        ? C(y)
        : function (d, k) {
          for (let z = T[0], M = 0; M < z.length; M++) {
            if (d.match(z[M][0])) {
      ...
      hooks: {
        ...
        '<': function (T, y) {
          ...
          if ((c = T.match(/^<<\s*/))) {
            const d = T.eat(/['"]/)
            T.eatWhile(/[\w\.]/)
            const k = T.current().slice(c[0].length + (d ? 2 : 1))
            if ((d && T.eat(d), k)) {
              return (
    ...
    o.defineMode(
      'php',
      function (T, y) {
        const c = o.getMode(T, (y && y.htmlMode) || 'text/html')
        ...
        return {
          startState: function () {
            const z = o.startState(c)
            const M = y.startOpen ? o.startState(d) : null
            return {
              html: z,
              php: M,
          ...
          copyState: function (z) {
            const M = z.html
            const w = o.copyState(c, M)
            const W = z.php
            const E = W && o.copyState(d, W)
            let N
            return (
              z.curMode == c ? (N = w) : (N = E),
              {
    ...
    o.defineMode('python', function (h, g) {
      ...
      function re (K, X, I) {
        ...
        if (K.match(E)) {
          ...
          return xe
            ? ((X.tokenize = q(K.current(), X.tokenize)),
              X.tokenize(K, X))
            : ((X.tokenize = O(K.current(), X.tokenize)),
              X.tokenize(K, X))
        }
        for (let F = 0; F < c.length; F++) {
          if (K.match(c[F])) return 'operator'
        }
        return K.match(y)
          ? 'punctuation'
      ...
      function Q (K, X, I) {
        const H = K.match(/^[\s\[\{\(]*(?:#|$)/, !1)
          ? null
          : K.column() + 1
        X.scopes.push({ offset: X.indent + k, type: I, align: H })
      }
      function R (K, X) {
        for (
          var I = K.indentation();
      ...
      function V (K, X) {
        ...
        if (
          ...
          H == ':' &&
                        ...
                        K.match(/^\s*(?:#|$)/, !1) &&
                        D(X),
          H.length == 1 && !/string|comment/.test(I))
        ) {
          let le = '[({'.indexOf(H)
          if (
            ...
            if (S(X).type == H) {
              X.indent = X.scopes.pop().offset - k
            } else return T
          }
        }
        return (
...
const qu = Ke((Au, Du) => {
  (function (o) {
    ...
    o.defineMode('ruby', function (g) {
      let T
      function y (E, N, G) {
        return G.tokenize.push(E), E(N, G)
      }
      function c (E, N) {
        ...
        let J
        if (G == '`' || G == "'" || G == '"') {
          return y(M(G, 'string', G == '"' || G == '`'), E, N)
        }
        if (G == '/') {
          return d(E) ? y(M(G, 'string-2', !0), E, N) : 'operator'
        }
        if (G == '%') {
          let re = 'string'
          let q = !0
          ...
          let O = E.eat(/[^\w\s=]/)
          return O
            ? (s.propertyIsEnumerable(O) && (O = s[O]),
              y(M(O, re, q, !0), E, N))
            : 'operator'
        } else {
          ...
          if (G == '?') {
            for (; E.match(/^\\[CM]-/););
            return (
              E.eat('\\') ? E.eatWhile(/\w/) : E.next(), 'string'
            )
          } else {
            if (G == ':') {
              return E.eat("'")
          ...
          function (N, G) {
            if (N.peek() == '}') {
              if (E == 1) {
                return (
                  G.tokenize.pop(),
                  G.tokenize[G.tokenize.length - 1](N, G)
                )
              }
      ...
      return {
        ...
        token: function (E, N) {
          (T = null), E.sol() && (N.indented = E.indentation())
          let G = N.tokenize[N.tokenize.length - 1](E, N)
          let J
          let re = T
          if (G == 'ident') {
            const q = E.current();
          ...
          return (
            (T || (G && G != 'comment')) && (N.lastTok = re),
            T == '|' && (N.varList = !N.varList),
            J == 'indent' || /[\(\[\{]/.test(T)
              ? (N.context = {
                  prev: N.context,
                  type: T || G,
    ...
    o.defineMode(
      ...
      function (p) {
        ...
        function M (q, O) {
          const D = q.peek()
          return D === ')'
            ? (q.next(), (O.tokenizer = J), 'operator')
            : D === '('
              ? (q.next(), q.eatSpace(), 'operator')
              : D === "'" || D === '"'
                ? ((O.tokenizer = W(q.next())), 'string')
                : ((O.tokenizer = W(')', !1)), 'string')
        }
        function w (q, O) {
          return function (D, Q) {
        ...
        function N (q) {
          if (q.indentCount == 0) {
            q.indentCount++
            const O = q.scopes[0].offset
            const D = O + p.indentUnit
        ...
        function J (q, O) {
          ...
          if (q.match('/*')) {
            return (
              (O.tokenizer = w(q.indentation(), !0)),
              O.tokenizer(q, O)
            )
          }
          if (q.match('//')) {
            return (
              (O.tokenizer = w(q.indentation(), !1)),
              O.tokenizer(q, O)
            )
          }
          if (q.match('#{')) return (O.tokenizer = E(J)), 'operator'
          if (D === '"' || D === "'") {
            return q.next(), (O.tokenizer = W(D)), 'string'
          }
          if (O.cursorHalf) {
            if (
              (D === '#' &&
              ...
              return z(q) && (O.cursorHalf = 0), 'number'
            }
            if (q.match(/^(px|em|in)\b/)) {
              return z(q) && (O.cursorHalf = 0), 'unit'
            }
            if (q.match(T)) {
              return z(q) && (O.cursorHalf = 0), 'keyword'
            }
            ...
            if (q.match(c)) {
              return z(q) && (O.cursorHalf = 0), 'operator'
            }
            if (q.eatWhile(/[\w-]/)) {
              return (
                z(q) && (O.cursorHalf = 0),
            ...
            if (z(q)) return (O.cursorHalf = 0), null
          } else {
            if (D === '-' && q.match(/^-\w+-/)) return 'meta'
            if (D === '.') {
              if ((q.next(), q.match(/^[\w-]+/))) {
                return N(O), 'qualifier'
              }
              if (q.peek() === '#') return N(O), 'tag'
            }
            if (D === '#') {
              if ((q.next(), q.match(/^[\w-]+/))) {
                return N(O), 'builtin'
            ...
            if (q.eatWhile(/[\w-]/)) {
              if (q.match(/ *: *[\w-\+\$#!\("']/, !1)) {
                k = q.current().toLowerCase()
                const Q = O.prevProp + '-' + k
                return C.hasOwnProperty(Q)
                  ? 'property'
                  : C.hasOwnProperty(k)
                    ? ((O.prevProp = k), 'property')
                    : s.hasOwnProperty(k)
                      ? 'property'
                      : 'tag'
              } else {
                return q.match(/ *:/, !1)
                  ? (N(O),
                    (O.cursorHalf = 1),
                    (O.prevProp = q.current().toLowerCase()),
                    'property')
                  : (q.match(/ *,/, !1) || N(O), 'tag')
              }
            }
            if (D === ':') {
              return q.match(d)
                ? 'variable-3'
                : (q.next(), (O.cursorHalf = 1), 'operator')
            }
          }
          return q.match(c) ? 'operator' : (q.next(), null)
        }
        function re (q, O) {
          q.sol() && (O.indentCount = 0)
          const D = O.tokenizer(q, O)
          const Q = q.current()
          if (((Q === '@return' || Q === '}') && G(O), D !== null)) {
            for (
              var R = q.pos - Q.length,
                V = R + p.indentUnit * O.indentCount,
                x = [],
                K = 0;
              K < O.scopes.length;
              K++
        ...
        return {
          ...
          token: function (q, O) {
            const D = re(q, O)
            return (
              (O.lastToken = { style: D, content: q.current() }),
              D
            )
          },
          indent: function (q) {
...
const Hu = Ke((ju, Ru) => {
  (function (o) {
    ...
    o.defineMode('shell', function () {
      const p = {}
      function v (d, k) {
        for (let z = 0; z < k.length; z++) p[k[z]] = d
      }
      const C = ['true', 'false']
      const b = [
        'if',
...
const Uu = Ke((Bu, Wu) => {
  (function (o) {
    ...
    o.defineMode('sql', function (g, T) {
      ...
      const k = T.keywords || s(S)
      const z = T.operatorChars || /^[*+\-%<>!=&|~^\/]/
      const M = T.support || {}
      const w = T.hooks || {}
      const W = T.dateSQL || { date: !0, time: !0, timestamp: !0 }
      const E = T.backslashStringEscapes !== !1
      const N = T.brackets || /^[\{}\(\)\[\]]/
      const G = T.punctuation || /^[;.,:]/
      function J (Q, R) {
        const V = Q.next()
        if (w[V]) {
          const x = w[V](Q, R)
    ...
    function s (g) {
      for (var T = {}, y = g.split(' '), c = 0; c < y.length; ++c) {
        T[y[c]] = !0
      }
      return T
    }
...
const ta = Ke(($u, Ku) => {
  (function (o) {
    ...
    o.defineMode('stylus', function (E) {
      ...
      function Le ($) {
        const B = /^\s*[-_]*[a-z0-9]+[\w-]*/i
        const se =
                    typeof $ === 'string' ? $.match(B) : $.string.match(B)
      ...
      return (
        ...
        (de.atBlock = function ($, B, se) {
          ...
          if (oe($, B)) return ke(se, B, 'interpolation')
          if ($ == 'word') {
            const De = B.current().toLowerCase()
            if (
        ...
        }),
        {
          ...
          indent: function ($, B, se) {
            const De = $.context
            const nt = B && B.charAt(0)
            let dt = De.indent
            const Pt = Le(B)
            const Ft = se.match(/^\s*/)[0].replace(/\t/g, G).length
    ...
    const z = p.concat(v, C, b, S, s, g, T, h, y, c, d, k)
    function M (E) {
      return (
        (E = E.sort(function (N, G) {
          return G > N
        })),
        new RegExp('^((' + E.join(')|(') + '))\\b')
      )
    ...
    function w (E) {
      for (var N = {}, G = 0; G < E.length; ++G) N[E[G]] = !0
      return N
    }
    function W (E) {
...
const Xu = Ke((Gu, Zu) => {
  (function (o) {
    ...
    'use strict'
    function p (q) {
      for (var O = {}, D = 0; D < q.length; D++) O[q[D]] = !0
      return O
    }
    const v = p([
      '_',
    ...
    const k = /^\.(?:\$\d+|(`?)[_A-Za-z][_A-Za-z$0-9]*\1)/
    const z = /^\#[A-Za-z]+/
    const M = /^@(?:\$\d+|(`?)[_A-Za-z][_A-Za-z$0-9]*\1)/
    function w (q, O, D) {
      if ((q.sol() && (O.indented = q.indentation()), q.eatSpace())) {
        return null
      }
      const Q = q.peek()
      if (Q == '/') {
        if (q.match('//')) return q.skipToEnd(), 'comment'
        if (q.match('/*')) return O.tokenize.push(N), N(q, O)
      }
      if (q.match(z)) return 'builtin'
      if (q.match(M)) return 'attribute'
      if (q.match(g) || q.match(T) || q.match(y) || q.match(c)) {
        return 'number'
      }
      ...
      let R
      if ((R = q.match(/("""|"|')/))) {
        const V = E.bind(null, R[0])
        return O.tokenize.push(V), V(q, O)
      }
      if (q.match(d)) {
        const x = q.current()
        return S.hasOwnProperty(x)
          ...
          : b.hasOwnProperty(x)
            ? 'atom'
            : v.hasOwnProperty(x)
              ? (C.hasOwnProperty(x) && (O.prev = 'define'),
                'keyword')
              : D == 'define'
                ? 'def'
                : 'variable'
          ...
          if (O.current() == '(') ++q
            ...
            if (q == 0) {
              return (
                O.backUp(1),
                D.tokenize.pop(),
                D.tokenize[D.tokenize.length - 1](O, D)
              )
            }
            --q
          }
    ...
    function E (q, O, D) {
      for (var Q = q.length == 1, R, V = !1; (R = O.peek());) {
        if (V) {
          if ((O.next(), R == '(')) {
          ...
          if (O.match(q)) return D.tokenize.pop(), 'string'
          O.next(), (V = R == '\\')
        }
      }
    ...
    function G (q, O, D) {
      (this.prev = q), (this.align = O), (this.indented = D)
    }
    function J (q, O) {
      const D = O.match(/^\s*($|\/[\/\*])/, !1) ? null : O.column() + 1
    ...
    o.defineMode('swift', function (q) {
      return {
        ...
        token: function (O, D) {
          const Q = D.prev
          D.prev = null
          const R = D.tokenize[D.tokenize.length - 1] || w
          const V = R(O, D, Q)
          if (
            (!V || V == 'comment'
              ? (D.prev = Q)
  ...
  (function (o) {
    ...
    o.defineMode('coffeescript', function (p, v) {
      ...
      function W (O, D) {
        ...
        const V = O.peek()
        if (O.match('####')) return O.skipToEnd(), 'comment'
        if (O.match('###')) return (D.tokenize = N), D.tokenize(O, D)
        if (V === '#') return O.skipToEnd(), 'comment'
        if (O.match(/^-?[0-9\.]/, !1)) {
          let x = !1
          if (
            (O.match(/^-?\d*\.\d+(e[\+\-]?\d+)?/i) && (x = !0),
            O.match(/^-?\d+\.\d*/) && (x = !0),
            O.match(/^-?\.\d+/) && (x = !0),
            x)
          ) {
            return O.peek() == '.' && O.backUp(1), 'number'
          }
          let K = !1
          if (
            (O.match(/^-?0x[0-9a-f]+/i) && (K = !0),
            O.match(/^-?[1-9]\d*(e[\+\-]?\d+)?/) && (K = !0),
            O.match(/^-?0(?![\dx])/i) && (K = !0),
            K)
          ) {
            return 'number'
        ...
        if (O.match(k)) {
          return (
            (D.tokenize = E(O.current(), !1, 'string')),
            D.tokenize(O, D)
          )
        }
        if (O.match(z)) {
          if (O.current() != '/' || O.match(/^.*\//, !1)) {
            return (
              (D.tokenize = E(O.current(), !0, 'string-2')),
              D.tokenize(O, D)
            )
          }
          O.backUp(1)
        }
        return O.match(S) || O.match(T)
          ? 'operator'
          : O.match(s)
            ? 'punctuation'
            : O.match(w)
              ? 'atom'
              : O.match(g) || (D.prop && O.match(h))
                ? 'property'
                : O.match(d)
                  ? 'keyword'
                  : O.match(h)
        ...
        return function (R, V) {
          for (; !R.eol();) {
            if ((R.eatWhile(/[^'"\/\\]/), R.eat('\\'))) {
              ...
              if (R.match(O)) return (V.tokenize = W), Q
              R.eat(/['"\/]/)
            }
          }
          return (
      ...
      function G (O, D, Q) {
        ...
        Q !== 'coffee'
          ? ((V = null), (x = O.column() + O.current().length))
      ...
      function J (O, D) {
        if (D.scope.prev) {
          if (D.scope.type === 'coffee') {
            for (
              var Q = O.indentation(), R = !1, V = D.scope;
              V;
              V = V.prev
            ) {
              if (Q === V.offset) {
      ...
      const q = {
        ...
        indent: function (O, D) {
          ...
          let Q = O.scope
          const R = D && '])}'.indexOf(D.charAt(0)) > -1
          if (R) for (; Q.type == 'coffee' && Q.prev;) Q = Q.prev
          const V = R && Q.type === D.charAt(0)
          return Q.align
            ? Q.alignOffset - (V ? 1 : 0)
            : (V ? Q.prev : Q).offset
        },
      ...
      function (p) {
        ...
        function qe (U, Z) {
          if (U.eat('.')) {
            ...
            return (
              Z.lastTag === 'script' &&
                            Z.scriptType.toLowerCase().indexOf('javascript') !=
                                -1
                ? (ce = Z.scriptType
                    .toLowerCase()
                    .replace(/"|'/g, ''))
...
`),
  ...
  let y = s.getLineHandle(h.line)
  const c = b(s, h.line, y, T)
  let d
  let k
  let z
  if (c === 'single') {
    const M = y.text.slice(0, h.ch).replace('`', '')
    const w = y.text.slice(h.ch).replace('`', '')
    s.replaceRange(
      M + w,
      { line: h.line, ch: 0 },
    ...
    if (h.line !== g.line || h.ch !== g.ch) {
      ...
      const W = s.getTokenAt({ line: d, ch: 1 })
      const E = C(W).fencedChars
      let N
      let G
      let J
      let re
...
`),
    ...
    const O = s.getLineHandle(k + 1)
    const D = O && s.getTokenAt({ line: k + 1, ch: O.text.length - 1 })
...
`,
    ...
    for (let R = d; R <= k; R++) s.indentLine(R, 'subtract')
    s.focus()
  } else {
    const V = h.line === g.line && h.ch === g.ch && h.ch === 0
    const x = h.line !== g.line
...
function bn (o) {
  ...
  if (
    (p.sideBySideRenderingFunction || (p.sideBySideRenderingFunction = y),
    S)
  ) {
...
Maximum file size is #image_max_size#.`,
  ...
  Te.prototype.render = function (o) {
    ...
    const C = {}
    function b (E) {
      const N = E.getInputField().form
      if (N) {
        const G = Array.from(N.elements)
        const J = G.indexOf(E.getInputField())
        J !== -1 && J + 1 < G.length && G[J + 1] && G[J + 1].focus()
      }
    }
    function S (E) {
      const N = E.getInputField().form
      ...
      p.shortcuts[s] !== null &&
                ...
                (function (E) {
                  C[vc(p.shortcuts[E])] = function () {
                    ...
                    typeof N === 'function'
                      ? N(v)
                      : typeof N === 'string' && window.open(N, '_blank')
                  }
                })(s)
    }
    ...
    function M (E, N) {
      ...
      E.setAttribute(
        ...
        '--bg-image:url(' +
                        ...
                        N.naturalWidth +
                        'px;--height:' +
                        k(N.naturalWidth, N.naturalHeight)
      ),
                  ...
                  if (
                    ...
                    if (
                      ...
                      if (p.imagesPreviewHandler) {
                        const re = p.imagesPreviewHandler(G[1])
  ...
  return {
    ...
    init: async function () {
      ...
      this.editor.codemirror.on('changes', (d, k) => {
        try {
          ...
          if (z.origin === '+input') {
            const M = '(https://)'
            const w = z.text[z.text.length - 1]
            if (w.endsWith(M) && w !== '[]' + M) {
              const W = z.from
              const E = z.to
              const G = z.text.length > 1 ? 0 : W.ch
              setTimeout(() => {
                d.setSelection(
                  {
                    line: E.line,
                    ch: G + w.lastIndexOf('(') + 1
                  },
                  {
                    line: E.line,
                    ch: G + w.lastIndexOf(')')
    ...
    getToolbar: function () {
      ...
      return (
        ...
        ['bold', 'italic', 'strike', 'link'].some((k) =>
          y.includes(k)
        ) &&
