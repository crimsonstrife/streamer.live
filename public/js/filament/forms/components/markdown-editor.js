...
`
    ...
    function El (e, t) {
      if (
        ...
        const n = Do(e, t);
        (ml(e, t, n, e.cm ? e.cm.curOp.id : NaN),
        On(e, t, n, io(e, t)))
        const r = []
        _r(e, function (i, a) {
          (!a &&
...
`,
    ...
    function ld (e, t, n) {
      ...
      return (
        ...
        i.moveOnDrag == null &&
                    (i.moveOnDrag = !(O ? n.altKey : n.ctrlKey)),
        i
      )
    }
    function sd (e, t, n, r) {
...
`)),
      ...
      Ie(e.scroller, 'paste', function (l) {
        if (!(lr(e, l) || ot(r, l))) {
          ...
          ((u.clipboardData = l.clipboardData),
          i.dispatchEvent(u))
        }
      }),
...
const ks = Ke((xs, _s) => {
  (function (o) {
    ...
    function S (w, W, E) {
      W = C(W, 'g')
      for (
        let O = E.line, G = E.ch, J = w.lastLine();
        O <= J;
        O++, G = 0
      ) {
        W.lastIndex = G
        const re = w.getLine(O)
        const q = W.exec(re)
        if (q) {
          return {
            from: p(O, q.index),
...
` +
        ...
        const D = W.exec(O)
        if (D) {
          const Q = O.slice(0, D.index).split(`
`)
          const R = D[0].split(`
`)
    ...
    function g (w, W, E) {
      W = C(W, 'g')
      for (
        let O = E.line, G = E.ch, J = w.firstLine();
        O >= J;
        O--, G = -1
      ) {
        const re = w.getLine(O)
...
` +
        ...
        const Q = h(O, W, J)
        if (Q) {
          const R = O.slice(0, Q.index).split(`
`)
          const V = Q[0].split(`
`)
          const x = re + R.length
    ...
    function k (w, W, E, O) {
      ...
      const J = G(W).split(/\r|\n\r?/)
      e: for (
        let re = E.line, q = E.ch, I = w.lastLine() + 1 - J.length;
        re <= I;
        re++, q = 0
      ) {
    ...
    function z (w, W, E, O) {
      ...
      const J = G(W).split(/\r|\n\r?/)
      e: for (
        let re = E.line, q = E.ch, I = w.firstLine() - 1 + J.length;
        re >= I;
        re--, q = -1
      ) {
        let D = w.getLine(re)
    ...
    o.defineExtension('selectMatches', function (w, W) {
      for (
        var E = [],
          O = this.getSearchCursor(w, this.getCursor('from'), W);
        O.findNext() &&
...
const Vo = Ke((ws, Ss) => {
  (function (o) {
    ...
    function D (N, H) {
      ...
      const xe = N.match(new RegExp('.*?\\)' + le + '"'))
    ...
    function Q (N, H) {
      ...
      le.length &&
                    ((H.helperType = N[0]),
                    o.registerHelper('hintWords', N[0], le)))
      for (let F = 0; F < N.length; ++F) o.defineMIME(N[F], H)
    }
    ...
    (Q('text/x-kotlin', {
      ...
      hooks: {
        ...
        indent: function (N, H, le, xe) {
          ...
          if (
            (N.prevToken == '}' || N.prevToken == ')') &&
                        le == ''
          ) {
            return N.indented
          }
          if (
            (N.prevToken == 'operator' &&
                            le != '}' &&
                            N.context.type != '}') ||
          ...
          if (H.align && H.type == '}') {
            return (
              H.indented +
                            (N.context.type == (le || '').charAt(0) ? 0 : xe)
            )
          }
        }
      },
...
const gn = Ke((Es, zs) => {
  (function (o) {
    ...
    o.defineMode('css', function (I, D) {
      ...
      const ge = I.highlightNonStandardPropertyKeywords !== !1
      let Oe
      let qe
      function Se (te, fe) {
        return ((Oe = fe), te)
      ...
      function D (x, K, X) {
        ...
        if (x == 'endTag' || x == 'selfcloseTag') {
          ...
          return (
            ...
            x == 'selfcloseTag' ||
                        s.autoSelfClosers.hasOwnProperty(w(N))
              ? O(X, N)
              : (O(X, N),
                (X.context = new W(X, N, H == X.indented))),
            G
          )
        }
        return ((y = 'error'), D)
          ...
          if (H && H[1]) {
            for (; N;) {
              if (N.tagName == H[2]) {
                ...
                s.implicitlyClosed.hasOwnProperty(w(N.tagName))
              ) {
                N = N.prev
              } else break
            }
            ...
            for (; N;) {
              const le = s.contextGrabbers[w(N.tagName)]
...
const vn = Ke((Is, Ns) => {
  (function (o) {
    ...
    (o.defineMode('javascript', function (p, v) {
      ...
      function $r (_, P) {
        if (P == 'as') {
          return ((R.marked = 'keyword'), x(ge('variable')))
        }
  ...
  (function (o) {
    ...
    (o.defineMode(
      ...
      function (T, y) {
        ...
        function w (W, E) {
          const O = c.token(W, E.htmlState)
          const G = /\btag\b/.test(O)
          let J
          if (
            G &&
                        !/[<>\s\/]/.test(W.current()) &&
    ...
    (o.simpleMode = function (y, c) {
      ...
      const G = {
        ...
        copyState: function (re) {
          ...
          for (let I = re.persistentStates; I; I = I.next) {
            q.persistentStates = {
              mode: I.mode,
              spec: I.spec,
              state:
    ...
    function S (y, c) {
      return function (d, k) {
        ...
        for (let W = y[k.state], E = 0; E < W.length; E++) {
          const O = W[E]
          const G = (!O.data.sol || d.sol()) && d.match(O.regex)
          if (G) {
            (O.data.next
              ? (k.state = O.data.next)
              : O.data.push
...
const Mu = Ke((Eu, zu) => {
  (function (o) {
    ...
    (o.defineMode('python', function (h, g) {
      ...
      const G = p(M)
      function J (K, X) {
        const N = K.sol() && X.lastToken != '\\'
        if (
          (N && (X.indent = K.indentation()), N && S(X).type == 'py')
        ) {
          const H = S(X).offset
          if (K.eatSpace()) {
        ...
        if (K.match(E)) {
          ...
          return xe
            ? ((X.tokenize = q(K.current(), X.tokenize)),
              X.tokenize(K, X))
            : ((X.tokenize = I(K.current(), X.tokenize)),
              X.tokenize(K, X))
        }
  ...
  (function (o) {
    ...
    (o.defineMode('ruby', function (g) {
      ...
      function c (E, O) {
        ...
        if (G == '/') {
          return d(E) ? y(M(G, 'string-2', !0), E, O) : 'operator'
        }
        if (G == '%') {
          let re = 'string'
          let q = !0
      ...
      return {
        ...
        token: function (E, O) {
          ...
          let G = O.tokenize[O.tokenize.length - 1](E, O)
          let J
          let re = T
          if (G == 'ident') {
            const q = E.current();
    ...
    (o.defineMode(
      ...
      function (p) {
        ...
        function O (q) {
          if (q.indentCount == 0) {
            q.indentCount++
            const I = q.scopes[0].offset
            const D = I + p.indentUnit
        ...
        function J (q, I) {
          ...
          if (q.match('/*')) {
            return (
              (I.tokenizer = w(q.indentation(), !0)),
              I.tokenizer(q, I)
            )
          }
          if (q.match('//')) {
            return (
              (I.tokenizer = w(q.indentation(), !1)),
              I.tokenizer(q, I)
            )
          }
          if (q.match('#{')) {
            return ((I.tokenizer = E(J)), 'operator')
          }
          if (D === '"' || D === "'") {
          ...
          if (I.cursorHalf) {
            ...
            if (q.match(T)) {
              return (z(q) && (I.cursorHalf = 0), 'keyword')
            }
            ...
            if (q.match(c)) {
              return (z(q) && (I.cursorHalf = 0), 'operator')
            }
            if (q.eatWhile(/[\w-]/)) {
              return (
                z(q) && (I.cursorHalf = 0),
        ...
        return {
          ...
          token: function (q, I) {
            const D = re(q, I)
            return (
              (I.lastToken = { style: D, content: q.current() }),
              D
            )
          },
          indent: function (q) {
...
const Xu = Ke((Gu, Zu) => {
  (function (o) {
    ...
    function w (q, I, D) {
      if ((q.sol() && (I.indented = q.indentation()), q.eatSpace())) {
        return null
      }
      const Q = q.peek()
      if (Q == '/') {
      ...
      if (q.match(d)) {
        ...
        return S.hasOwnProperty(x)
          ...
          : b.hasOwnProperty(x)
            ? 'atom'
            : v.hasOwnProperty(x)
              ? (C.hasOwnProperty(x) && (I.prev = 'define'),
                'keyword')
              : D == 'define'
                ? 'def'
                : 'variable'
    ...
    function J (q, I) {
      const D = I.match(/^\s*($|\/[\/\*])/, !1) ? null : I.column() + 1
  ...
  (function (o) {
    ...
    (o.defineMode('coffeescript', function (p, v) {
      ...
      function W (I, D) {
        ...
        if (I.match(k)) {
          return (
            (D.tokenize = E(I.current(), !1, 'string')),
            D.tokenize(I, D)
          )
        }
        if (I.match(z)) {
      ...
      function J (I, D) {
        if (D.scope.prev) {
          if (D.scope.type === 'coffee') {
            for (
              var Q = I.indentation(), R = !1, V = D.scope;
              V;
              V = V.prev
            ) {
              if (Q === V.offset) {
...
function Pi (o) {
  ...
  function b (K, X, N, H, le) {
    ...
    (le =
                le ||
                (!!N.text &&
                    K.getTokenAt({ line: X, ch: N.text.length - 1 }))))
...
`),
    ...
    const I = s.getLineHandle(k + 1)
    const D = I && s.getTokenAt({ line: k + 1, ch: I.text.length - 1 })
...
Maximum file size is #image_max_size#.`,
  ...
  Te.prototype.uploadImagesUsingCustomFunction = function (o, p) {
    if (p.length !== 0) {
      for (var v = [], C = 0; C < p.length; C++) {
        (v.push(p[C].name),
        this.uploadImageUsingCustomFunction(o, p[C]))
      }
      this.updateStatusBar(
        'upload-image',
        this.options.imageTexts.sbOnDrop.replace(
  ...
  Te.prototype.render = function (o) {
    ...
    const C = {}
    function b (E) {
      const O = E.getInputField()
      const G = O.form
      if (G) {
        const J = Array.from(G.elements).filter(
          (q) =>
            !(
