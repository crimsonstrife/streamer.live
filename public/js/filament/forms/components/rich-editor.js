...
let { freeze: U, seal: G, create: Vr } = Object
...
const Ne = K(Array.prototype.forEach)
const or = K(Array.prototype.pop)
const oe = K(Array.prototype.push)
const _e = K(String.prototype.toLowerCase)
const Fn = K(String.prototype.toString)
const sr = K(String.prototype.match)
const se = K(String.prototype.replace)
const _o = K(String.prototype.indexOf)
const jo = K(String.prototype.trim)
const $ = K(Object.prototype.hasOwnProperty)
const _ = K(RegExp.prototype.test)
const ae =
    ((ar = TypeError),
    function () {
...
const zo = G(/\{\{[\w\W]*|[\w\W]*\}\}/gm)
const Ho = G(/<%[\w\W]*|[\w\W]*%>/gm)
const qo = G(/\$\{[\w\W]*}/gm)
const Jo = G(/^data-[\-\w.\u00B7-\uFFFF]+$/)
const Ko = G(/^aria-[\-\w]+$/)
const zr = G(
...
const Go = G(/^(?:\w+script|data):/i)
const $o = G(/[\u0000-\u0020\u00A0\u1680\u180E\u2000-\u2029\u205F\u3000]/g)
const Hr = G(/^html$/i)
const Yo = G(/^[a-z][.\w]*(-[.\w]+)+$/i)
...
const Ve = (function i () {
  ...
  const M = u.prototype
  const mt = le(M, 'cloneNode')
  const yt = le(M, 'remove')
...
`)
  ...
  consolidateWith (t) {
    const e = J.textForStringWithAttributes(`
`)
...
const As = J.textForStringWithAttributes(
    `
`,
    { blockBreak: !0 }
)
...
const V = class extends ht {
  static fromJSON (t) {
    return new this(Array.from(t).map((e) => bt.fromJSON(e)))
  }

  static fromString (t, e) {
    const n = J.textForStringWithAttributes(t, e)
...
const it = class extends R {
  ...
  insertString (t, e) {
    ...
    const r = J.textForStringWithAttributes(t, n)
  ...
  insertLineBreak () {
    ...
    if (t.shouldPrependListItem()) {
      const e = new V([t.block.copyWithoutText()])
      return this.insertDocument(e)
    }
...
`)
  ...
  insertHTML (t) {
    const e = Ft.parse(t).getDocument()
    const n = this.getSelectedRange()
  ...
  insertAttachments (t) {
    ...
    return (
      Array.from(t).forEach((n) => {
        ...
        s && (l.presentation = s)
        const c = J.textForAttachmentWithAttributes(n, l)
        e = e.appendText(c)
      }),
      this.insertText(e)
    )
  ...
  setTextAttribute (t, e) {
    ...
    if (t === 'href') {
      const s = J.textForStringWithAttributes(e, { href: e })
...
`
    ...
    const s = new V([n.removeLastAttribute().copyWithoutText()])
    return (
...
const { lang: Vn, css: Et, keyNames: Ms } = Ce
const zn = function (i) {
  return function () {
