...
<div class="px-4 py-4 md:py-8">
    <div class="mx-auto max-w-7xl">
        <div class="aspect-w-16 aspect-h-9">
            <iframe src="https://embed.twitch.tv/?allowfullscreen=true&channel={{ $channel }}&layout=video&parent={{ request()->getHost() }}" height="400" width="100%" allow="autoplay; fullscreen" scrolling="no" allowfullscreen
