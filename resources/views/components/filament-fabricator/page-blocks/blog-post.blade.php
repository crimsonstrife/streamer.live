            ...
            <div class="row">
                <div class="mb-3">
                    <form method="POST"
                        ...
                        @csrf
                        <button class="btn btn-sm btn-outline-primary" type="submit"><x-fas-thumbs-up height="1rem"/> Like
                ...
                <div class="mb-3">
                    <form method="POST"
                        ...
                        @csrf
                        <button class="btn btn-sm btn-outline-primary" type="submit"><x-fas-thumbs-down height="1rem"/> Dislike
